...
dsigmas  = sigmas*0.09
#sigmas = np.loadtxt('/data/ljo31b/EELs/phys_models/models/'+str(NAME)+'HYPER.dat')/100.
sigmas = np.load('/data/ljo31b/EELs/FP/inference/models/'+str(NAME)+'_sigmas_HYPER.npy')/100.
#sigmas = np.load('/data/ljo31b/EELs/FP/inference/models/NFW_12_scale_sigmas.npy')/100.
#sigmas = np.load('/data/ljo31b/EELs/FP/inference/models/gNFW_12_sigmas.npy')/100.
...
dxx,dyy,dzz = dsigmas/sigmas/np.log(10.)/100., dlogI, dre/re/np.log(10.)
...
pars, cov = [], []
pars.append(pymc.Uniform('a',0.,3,1.0 ))
...
S.sample(5000)
outFile = '/data/ljo31b/EELs/FP/inference/models/FP_HYPERPARAMS_'+str(NAME)
f = open(outFile,'wb')
