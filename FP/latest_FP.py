...
fp = np.load('/data/ljo31b/EELs/esi/kinematics/inference/results_1.50_source_vdfit.npy')
l,m,u = fp
...
#rvd = np.load('/data/ljo31b/EELs/SIGS_SDSS_3.npy')
#for i in range(13):
#    print rvd[i],sigmas[i]*100
...
S.sample(2000)
#S.sample(8000)
outFile = '/data/ljo31b/EELs/FP/inference/latest_FP'
f = open(outFile,'wb')
