...
RE,VD = np.loadtxt('/data/ljo31b/EELs/phys_models/models/NFW_normal_AMscatter.dat').T
...
pl.figure()
pl.scatter(1.6*xx-0.7*yy,zz,color='SteelBlue')
pl.figure()
pl.scatter(1.3*xx-0.7*yy,zz,color='SteelBlue')
pl.show()
