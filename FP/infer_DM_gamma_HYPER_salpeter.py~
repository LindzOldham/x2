...
for i in range(len(names)):
    ints.append(np.load('/data/ljo31b/EELs/phys_models/models/interpolators/gNFW_gamma_12_LO_M_'+names[i]+'.npy')[()])
...
np.save('/data/ljo31b/EELs/FP/inference/models/gNFW_gamma_12_sigmas_HYPER_LO_M',s2)
