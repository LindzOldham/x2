...
np.save('/data/ljo31/Lens/LensParams/logI_obsframe.npy',logI)

#_,_,_,_,_,_,logIb,logIv,logIi = np.load('/data/ljo31/Lens/LensParams/BVI_photometry_212.npy').T
#logI = logIi-8.5
...
#S.sample(5000)
outFile = '/data/ljo31b/EELs/FP/inference/FP_10_logI'
#f = open(outFile,'wb')
