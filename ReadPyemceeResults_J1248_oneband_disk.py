...
result = np.load('/data/ljo31/Lens/J1248/emcee9')
lp= result[0]
a2=0.
...
for i in range(len(imgs)):
    ...
    for src in srcs:
        src.setPars()
        tmp = xc*0.
        tmp = src.boxypixeval(x0,y0,1./OVRS,csub=11,c=5)
...
re3,n3,pa3,q3,x3,y3 = dic['Galaxy 2 xmax'][a1,a2,a3], dic['Galaxy 2 x0'][a1,a2,a3], dic['Galaxy 2 pa'][a1,a2,a3], dic['Galaxy 2 y0'][a1,a2,a3], dic['Galaxy 2 x'][a1,a2,a3], dic['Galaxy 2 y'][a1,a2,a3]
