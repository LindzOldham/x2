...
print src1mag606, src1mag814, src2mag606,src2mag814
F = 10**(0.4*(ZP-src1mag606)) + 10**(0.4*(ZP-src2mag606))
mag_src = -2.5*np.log10(F) + 26.493
print mag_src
F = 10**(0.4*(ZP-src1mag814)) + 10**(0.4*(ZP-src2mag814))
mag_src = -2.5*np.log10(F) + 25.95
print mag_src
