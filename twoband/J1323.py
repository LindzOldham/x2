...
'''
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=7,nwalkers=56,ntemps=3)
S.sample(500)
...
jj=0
for jj in range(12):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=7,nwalkers=56,ntemps=3,initialPars=trace[-1]) #too complicated!
    print 'sampling'
    S.sample(1000)
