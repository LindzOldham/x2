...
X='212_2_ctd' # with everything - lens on, big image, ovrs=2!!!
print X
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=32,nwalkers=52,ntemps=3,initialPars=trace[-1,:,:52])
S.sample(1000)
outFile = '/data/ljo31/Lens/J1347/twoband_'+str(X)
f = open(outFile,'wb')
