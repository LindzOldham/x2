...
X=1 # with everything - lens on, big image, ovrs=2!!!
print X
...
jj=0
for jj in range(12):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=52,ntemps=3,initialPars=trace[-1]) #too complicated!
    print 'sampling'
    S.sample(1000)
