...
result = np.load('/data/ljo31/Lens/J1125/twoband_212_pte_ctd')
...
covs = dict([('x',0.05),('y',0.05),('q',0.01),('pa',1.),('re',0.2),('n',0.2)])
covlens = dict([('x',0.05),('y',0.05),('q',0.01),('pa',1.),('b',0.1),('eta',0.1)])
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=60,ntemps=2,initialPars=trace[-1,:2])
S.sample(500)
...
pl.figure()
pl.imshow(components[0],interpolation='nearest',origin='lower')
pl.figure()
pl.imshow(components[1],interpolation='nearest',origin='lower')
