...
X='3_pte' # initialising using 2_emcee, but increasing walkers from 52 to 64
print X
...
result = np.load('/data/ljo31/Lens/J1125/twoband_3_emcee_nw100')
...
for i in range(components.shape[0]):
    pl.figure()
    pl.imshow(np.log10(components[i]),vmin=-4,vmax=-1)
    pl.colorbar()
