...
result = np.load('/data/ljo31/Lens/J1144/twoband_212')#LensModels/J1144_212_allparams')
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=56,ntemps=2,initialPars=trace[-1])
S.sample(500)
