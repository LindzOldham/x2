...
result = np.load('/data/ljo31/Lens/J1605/twoband_212_ctd')#LensModels/J1605_212_final')
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=32,nwalkers=60,ntemps=2,initialPars=trace[-1])
S.sample(500)
outFile = '/data/ljo31/Lens/J1605/twoband_'+str(X)
f = open(outFile,'wb')
