...
X='3_emcee' # with everything - lens on, big image, ovrs=2!!!
print X
...
img1 = py.open('/data/ljo31/Lens/J0913/F555W_sci_cutout_huge3.fits')[0].data.copy()
sig1 = py.open('/data/ljo31/Lens/J0913/F555W_noisemap_huge3.fits')[0].data.copy()
psf1 = py.open('/data/ljo31/Lens/J0913/F555W_psf4.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)

img2 = py.open('/data/ljo31/Lens/J0913/F814W_sci_cutout_huge3.fits')[0].data.copy()
sig2 = py.open('/data/ljo31/Lens/J0913/F814W_noisemap_huge3.fits')[0].data.copy()
...
yc,yo=yc-130,yo-130
xc,xo=xc-130,xo-130
mask = py.open('/data/ljo31/Lens/J0913/mask_huge3.fits')[0].data +py.open('/data/ljo31/Lens/J0913/mask_huge3b.fits')[0].data 
...
'''
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=32,nwalkers=56,ntemps=3)
S.sample(500)
...
jj=0
for jj in range(12):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=32,nwalkers=56,ntemps=3,initialPars=trace[-1]) #too complicated!
    print 'sampling'
    S.sample(1000)
