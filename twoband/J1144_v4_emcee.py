...
X='4_emcee' # emcee and smaller cutout! # with everything - lens on, big image, ovrs=2!!!
print X
...
img1 = py.open('/data/ljo31/Lens/J1144/F606W_sci_cutout_huger.fits')[0].data.copy()[100:-100,100:-100]
sig1 = py.open('/data/ljo31/Lens/J1144/F606W_noisemap_huger.fits')[0].data.copy()[100:-100,100:-100]
psf1 = py.open('/data/ljo31/Lens/J1144/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)
img2 = py.open('/data/ljo31/Lens/J1144/F814W_sci_cutout_huger.fits')[0].data.copy()[100:-100,100:-100]
sig2 = py.open('/data/ljo31/Lens/J1144/F814W_noisemap_huger.fits')[0].data.copy()[100:-100,100:-100]
...
result = np.load('/data/ljo31/Lens/J1144/twoband_1')
...
yc,yo=yc-40,yo-40
xc,xo=xc-45,xo-45
mask = py.open('/data/ljo31/Lens/J1144/mask_huger.fits')[0].data[100:-100,100:-100]
...
'''
S = myEmcee.PTEmcee(pars+[logP,likelihood],cov=optCov,nthreads=32,nwalkers=52,ntemps=3)
S.sample_blobs(500)
outFile = '/data/ljo31/Lens/J1144/twoband_'+str(X)
f = open(outFile,'wb')
