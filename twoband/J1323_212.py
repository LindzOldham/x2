...
X='212_ctd_ctd' # with everything - lens on, big image, ovrs=2!!!
print X
...
result = np.load('/data/ljo31/Lens/J1323/twoband_212_ctd')
...
covs = dict([('x',0.1),('y',0.1),('q',0.05),('pa',1.),('re',0.5),('n',0.5)])
covlens = dict([('x',0.1),('y',0.1),('q',0.05),('pa',1.),('b',0.1),('eta',0.1)])
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=32,nwalkers=60,ntemps=3,initialPars=trace[-1])
S.sample(500)
outFile = '/data/ljo31/Lens/J1323/twoband_'+str(X)
f = open(outFile,'wb')
