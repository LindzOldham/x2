...
img1 = py.open('/data/ljo31/Lens/J1125/F606W_sci_cutout_huge.fits')[0].data.copy()
sig1 = py.open('/data/ljo31/Lens/J1125/F606W_noisemap_huge.fits')[0].data.copy()
psf1 = py.open('/data/ljo31/Lens/J1125/F606W_psf3_filledin.fits')[0].data.copy()
psf1 = psf1[5:-7,5:-6]
psf1 = psf1/np.sum(psf1)

img2 = py.open('/data/ljo31/Lens/J1125/F814W_sci_cutout_huge.fits')[0].data.copy()
sig2 = py.open('/data/ljo31/Lens/J1125/F814W_noisemap_huge.fits')[0].data.copy()
...
result = np.load('/data/ljo31/Lens/J1125/twoband_0')
lp,trace,dic,_= result
a2=0
a1,a3 = numpy.unravel_index(lp[:,0].argmax(),lp[:,0].shape)
lresult = np.load('/data/ljo31/Lens/LensModels/J1125_211')
...
key = 'eta'
p[key] = dic[key][a1,a2,a3]
lenses.append(MassModels.PowerLaw('Lens 1',p))

p = {}
p['x'] = lenses[0].pars['x']
p['y'] = lenses[0].pars['y']
p['b'] = ldic['extShear'][la1,la2,la3]
p['pa'] = ldic['extShear PA'][la1,la2,la3]
