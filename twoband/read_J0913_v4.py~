...
result = np.load('/data/ljo31/Lens/J0913/twoband_3')
...
for key in ['Source 1 re', 'Source 1 n', 'Galaxy 1 re', 'Galaxy 1 n', 'Galaxy 2 re', 'Galaxy 2 n']:
    pl.figure()
    pl.subplot(211)
    pl.hist(dic[key][:,0].ravel(),30,normed=True,histtype='stepfilled',alpha=0.5,label='even bigger box')
    pl.hist(ldic[key][:,0].ravel(),30,normed=True,histtype='stepfilled',alpha=0.5,label='big box')
