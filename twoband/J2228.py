...
X=0 # with everything - lens on, big image, ovrs=2!!!
print X
...
img1 = py.open('/data/ljo31/Lens/J2228/F555W_sci_cutout.fits')[0].data.copy()[45:-45]#[120:-110,25:-25]        
sig1 = py.open('/data/ljo31/Lens/J2228/F606W_noisemap.fits')[0].data.copy()[45:-45]#[120:-110,25:-25]    
psf1 = py.open('/data/ljo31/Lens/J2228/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)
img2 = py.open('/data/ljo31/Lens/J2228/F814W_sci_cutout.fits')[0].data.copy()[45:-45]#[120:-110,25:-25]   
sig2 = py.open('/data/ljo31/Lens/J2228/F814W_noisemap.fits')[0].data.copy()[45:-45]#[120:-110,25:-25]      
...
def logP(value=0.,p=pars):
    ...
    for i in range(len(imgs)):
        ...
        for gal in gals:
            gal.setPars()
            tmp = xc*0.
            tmp[mask2] = gal.pixeval(xin,yin,1./OVRS,csub=31) 
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=56,ntemps=3)
S.sample(500)
outFile = '/data/ljo31/Lens/J2228/twoband_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(12):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=56,ntemps=3,initialPars=trace[-1]) #too complicated!
    print 'sampling'
    S.sample(1000)
