...
X='4_emcee' # with everything - lens on, big image, ovrs=2!!!
print X
# now taking the size back down and seeing if we can recover the same params
...
img1 = py.open('/data/ljo31/Lens/J0913/F555W_sci_cutout_huge3.fits')[0].data.copy()[100:-100,100:-100]
sig1 = py.open('/data/ljo31/Lens/J0913/F555W_noisemap_huge3.fits')[0].data.copy()[100:-100,100:-100]
psf1 = py.open('/data/ljo31/Lens/J0913/F555W_psf4.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)

img2 = py.open('/data/ljo31/Lens/J0913/F814W_sci_cutout_huge3.fits')[0].data.copy()[100:-100,100:-100]
sig2 = py.open('/data/ljo31/Lens/J0913/F814W_noisemap_huge3.fits')[0].data.copy()[100:-100,100:-100]
...
result = np.load('/data/ljo31/Lens/J0913/twoband_1')
...
yc,yo=yc-30,yo-30
xc,xo=xc-30,xo-30
mask = py.open('/data/ljo31/Lens/J0913/mask_huge3.fits')[0].data[100:-100,100:-100] +py.open('/data/ljo31/Lens/J0913/mask_huge3b.fits')[0].data[100:-100,100:-100]
...
S = myEmcee.Emcee(pars+[logP,likelihood],cov=optCov,nthreads=32,nwalkers=56)
S.sample_blobs(500)
...
jj=0
for jj in range(12):
    #S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=56,ntemps=3,initialPars=trace[-1]) #too complicated!
    S.p0 = trace[-1]
    print 'sampling'
    S.sample_blobs(1000)
    ...
    outFile = '/data/ljo31/Lens/J0913/twoband_blobs_'+str(X)
    f = open(outFile,'wb')
...
labels = ['xoffset','yoffset','gal 1 x','gal 1 y', 'gal 1 q', 'gal 1 pa','gal 1 re', 'gal 1 n', 'gal 2 x','gal 2 y', 'gal 2 q', 'gal 2 pa','gal 2 re', 'gal 2 n', 'lens x','lens y', 'lens q', 'lens pa','lens b', 'lens eta','shear','shear pa','src q','src re','src n','src pa','src x','src y']
