...
dxx,dyy,dzz = dsigmas[:-1]/sigmas[:-1]/np.log(10.), dmu[:-1]/mu[:-1]/np.log(10.), dre[:-1]/re[:-1]/np.log(10.)
...
S.sample(6000)
outFile = '/data/ljo31b/EELs/inference/FP/src_211_huge'
f = open(outFile,'wb')
...
pl.title('EELs')
pl.savefig('/data/ljo31b/EELs/inference/FP/src211huge.pdf')
pl.show()
