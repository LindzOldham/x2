...
pars.append(pymc.Uniform('mu y',1.,5. ))
pars.append(pymc.Uniform('tau x',0,1,value=0.1 ))
pars.append(pymc.Uniform('tau y',0,6,value=0.2 ))
pars.append(pymc.Uniform('rho',-1.,1,-0.5 ))
pars.append(pymc.Uniform('sigma',0,2,0.1 )) 
cov += [1.,1.,0.1,0.1,0.05,0.1,0.1,0.05]
optCov = np.array(cov)
...
S.sample(6000)
outFile = '/data/ljo31b/EELs/FP/inference/FP_src_logI_211_fixeda'
f = open(outFile,'wb')
