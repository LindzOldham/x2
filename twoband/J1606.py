...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=56,ntemps=3,initialPars=trace[-1])
S.sample(500)
outFile = '/data/ljo31/Lens/J1606/twoband_'+str(X)
f = open(outFile,'wb')
...
pl.figure()
pl.imshow(components[0],origin='lower',interpolation='nearest')
pl.figure()
pl.imshow(components[1],origin='lower',interpolation='nearest')
pl.figure()
pl.imshow(components[2],origin='lower',interpolation='nearest')
