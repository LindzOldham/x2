...
los = dict([('q',0.05),('pa',-180.),('re',0.1),('n',0.18)])
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=32,nwalkers=56,ntemps=3,initialPars=trace[-1])
S.sample(500)
outFile = '/data/ljo31/Lens/J1446/twoband_'+str(X)
f = open(outFile,'wb')
