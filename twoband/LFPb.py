...
phot = py.open('/data/ljo31/Lens/LensParams/Phot_1src_lensgals_huge_new.fits')[1].data
...
S.sample(6000)
outFile = '/data/ljo31b/EELs/inference/FP/lens_211_huge_rm2'
f = open(outFile,'wb')
...
pl.title('EELs')
pl.savefig('/data/ljo31b/EELs/inference/FP/lens211hugerm2.pdf')
pl.show()
