...
X='superbig' # with everything - lens on, big image, ovrs=2!!!
print X
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=56,ntemps=2,initialPars=trace[-1,:2])
S.sample(500)
