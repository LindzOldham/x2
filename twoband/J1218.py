...
img1 = py.open('/data/ljo31/Lens/J1218/F606W_sci_cutout_huge.fits')[0].data.copy()
sig1 = py.open('/data/ljo31/Lens/J1218/F606W_noisemap_huge.fits')[0].data.copy()
psf1 = py.open('/data/ljo31/Lens/J1218/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)
img2 = py.open('/data/ljo31/Lens/J1218/F814W_sci_cutout_huge.fits')[0].data.copy()
sig2 = py.open('/data/ljo31/Lens/J1218/F814W_noisemap_huge.fits')[0].data.copy()
...
S.sample(500)
outFile = '/data/ljo31/Lens/J1218/twoband_'+str(X)
f = open(outFile,'wb')
