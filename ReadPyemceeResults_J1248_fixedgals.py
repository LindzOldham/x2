...
sig1 = py.open('/data/ljo31/Lens/J1248/sig1_addedagain2.fits')[0].data.copy()[10:-10,10:-25]
sig2 = py.open('/data/ljo31/Lens/J1248/sig2_addedagain2.fits')[0].data.copy()[10:-10,10:-25]


result = np.load('/data/ljo31/Lens/J1248/emcee98')
lp= result[0]
a2=0.
...
guiFile = '/data/ljo31/Lens/J1248/nur2'
