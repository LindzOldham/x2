...
X=3 - 1_Iband. Put X=1 bak into gui and now on I band. offsets: no offsets. Problem is I keep changing the image size and it's gettting really confusing!
X=4 - twoband
X=6 - 2_Iband2
X = 6 offsets: xo,xc=xo-25,xc-25, yo,yc=yo-30,yc-30
'''
...
result = np.load('/data/ljo31/Lens/J1619/emcee13')
lp= result[0]
...
mask_V = py.open('/data/ljo31/Lens/J1619/mask.fits')[0].data.copy()
mask_I = mask_V.copy()
