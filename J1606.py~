...
Vcut = V[2072-35:2072+20,2279-20:2279+30]
...
V_wht_cut = V_wht[2072-35:2072+20,2279-20:2279+30]

pl.figure()
pl.imshow(np.log10(V_wht_cut),origin='lower',interpolation='nearest')

py.writeto('/data/ljo31/Lens/SDSSJ1606+2235_F606W_wht_cutout.fits',V_wht_cut,header_wht,clobber=True)
py.writeto('/data/ljo31/Lens/SDSSJ1606+2235_F606W_sci_cutout.fits',Vcut,header,clobber=True)
...
Icut = I[2072-35:2072+20,2279-20:2279+30]
...
I_wht_cut = I_wht[2072-35:2072+20,2279-20:2279+30]

pl.figure()
pl.imshow(np.log10(I_wht_cut),origin='lower',interpolation='nearest')

py.writeto('/data/ljo31/Lens/SDSSJ1606+2235_F814W_wht_cutout.fits',V_wht_cut,header_wht,clobber=True)
py.writeto('/data/ljo31/Lens/SDSSJ1606+2235_F814W_sci_cutout.fits',Vcut,header,clobber=True)
