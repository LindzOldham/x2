...
im = py.open('/data/ljo31/Lens/'+str(name[:5])+'/F555W_sci_cutout_big.fits')[0].data.copy()
wht = py.open('/data/ljo31/Lens/'+str(name[:5])+'/F555W_wht_cutout_big.fits')[0].data.copy()
...
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F555W_noisemap_big.fits',noisemap,clobber=True)
pl.figure()
