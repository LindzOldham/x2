...
!f2py integer intent(hide),depend(x) :: n=len(x)
      ...
      double precision xintegrand(51),yintegrand(51),uvar(51)
      double precision u,u2
      double precision rein,eta,s,q,x2,y2,q2,u2q2
      ...
      double precision function doint(u,integrand)
      double precision u(51),integrand(51),w(51)
      double precision xb,xe,s,fp
      integer iopt,m,k,nest,n,lwrk,ier
      double precision t(55),c(55),wrk(1084)
      integer iwrk(55)
