...
kresult = np.load('/data/ljo31/Lens/J0901/KeckPSF_final_211_srcs')
klp= kresult[0]
ka2=0
...
xoffset,yoffset,sig1,q1,pa1,amp1,sig2,q2,pa2,amp2,sig3,q3,pa3,amp3,sig4,q4,pa4,amp4,sig5,q5,pa5,amp5 = ktrace[ka1,ka2,ka3,:22]
...
print '%.2f'%sig5,'&','%.2f'%q5,'&', '%.2f'%pa5,'&','%.2f'%amp5, r'\\\hline'
