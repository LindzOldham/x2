...
X=13 - starting off the disk in a diferent place to see if we can find a better fit. ovrs=2.
X=19 - using exponential disk (not sech2)
...
pars.append(pymc.Uniform('Galaxy 2 xmax',0,200,value=40))
...
pars.append(pymc.Uniform('Galaxy 2 x0',0,200,value=15))
pars.append(pymc.Uniform('Galaxy 2 y0',0.1,15,value=0.7))
cov += [0.5,1.,1.,5.,1.,0.5]
gals.append(SBBModels.ExpDisk('Galaxy 2',{'x':pars[-5],'y':pars[-4],'pa':pars[-3],'x0':pars[-2],'y0':pars[-1],'xmax':pars[-6]}))
print gals[1].pars
