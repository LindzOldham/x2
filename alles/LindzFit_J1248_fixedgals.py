...
X = 99 # gui_100c - 3/1/1!
X=98 # nur2 with addedagain2 noisemaps...
'''X=100 - seTup3'''
print X
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=32,ntemps=3)
S.sample(1000)
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=32,ntemps=3,initialPars=trace[a1])
    S.sample(1000)
