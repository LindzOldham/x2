...
logR,logM,dlogR,dlogM,rho = np.load('/data/ljo31/Lens/LensParams/ReMass_2src_ljo.npy').T
name = py.open('/data/ljo31/Lens/LensParams/Phot_1src_new.fits')[1].data['name']
...
name = py.open('/data/ljo31/Lens/LensParams/Phot_1src_new.fits')[1].data['name'][nuggets]
print name
