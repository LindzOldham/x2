...
X=1 - new1
X=2 - new0
X=3 - gui_0. THis is an old model. See if it needs such a big source really! Also see what the individual-band fits did!
X=4 - new_2 - 2/1/1 new gui model.
X=5 - new_3'''
# This is a huge lens gaalxy and will take forever and ever and ever...?
X =3
X=4
X=5
print X
...
img1 = py.open('/data/ljo31/Lens/J2228/F555W_sci_cutout.fits')[0].data.copy()[200:-190,105:-105]#[120:-110,25:-25]        
sig1 = py.open('/data/ljo31/Lens/J2228/F606W_noisemap.fits')[0].data.copy()[200:-190,105:-105]#[120:-110,25:-25]    
psf1 = py.open('/data/ljo31/Lens/J2228/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)

img2 = py.open('/data/ljo31/Lens/J2228/F814W_sci_cutout.fits')[0].data.copy()[200:-190,105:-105]#[120:-110,25:-25]   
sig2 = py.open('/data/ljo31/Lens/J2228/F814W_noisemap.fits')[0].data.copy()[200:-190,105:-105]#[120:-110,25:-25]      
psf2 = py.open('/data/ljo31/Lens/J2228/F814W_psf1.fits')[0].data.copy()
psf2 = psf2/np.sum(psf2)

guiFile = '/data/ljo31/Lens/J2228/new_3'
...
mask = py.open('/data/ljo31/Lens/J2228/mask.fits')[0].data.copy()[200:-190,105:-105]#[200:-150,65:-65]#[120:-110,25:-25] 
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=56,ntemps=3)
S.sample(1000)
outFile = '/data/ljo31/Lens/J2228/new_211_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(30):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=56,ntemps=3,initialPars=trace[-1])
    S.sample(1000)
