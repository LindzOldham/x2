...
logRe,logM,dlogRe,dlogM,rho = np.load('/data/ljo31/Lens/LensParams/ReMass_2src.npy').T
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/sizemass_2src_inferredage_wideprior_nuggets'
f = open(outFile,'wb')
...
np.save('/data/ljo31/Lens/Analysis/sizemass_2src_nuggets_fit',np.column_stack((xfit,yfit,lo,up)))
