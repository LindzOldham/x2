...
xfit,yfit,lo,up = np.load('/data/ljo31/Lens/Analysis/sizemass_2src_nuggets_fit.npy').T
xfit,yfit1,lo1,up1 = np.load('/data/ljo31/Lens/Analysis/sizemass_1src_nuggets_fit.npy').T
