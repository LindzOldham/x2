...
v[:9],i[:9],k[:9],Re[:9] = table['mag v'],table['mag i'],table_k['mag k'],table_k['Re k']
Re[9],Re[10],Re[11] = table2_k['Re k'][0], table2_k['Re k'][1], table2_k['Re k'][5]
...
dRe[:9] = np.min((table_k['Re k hi'],table_k['Re k lo']),axis=0)
dRe[9],dRe[10],dRe[11] = np.min((table2_k['Re k hi'][0],table2_k['Re k lo'][0])), np.min((table2_k['Re k hi'][1],table2_k['Re k lo'][1])), np.min((table2_k['Re k hi'][5],table2_k['Re k lo'][5]))
...
np.save('/data/ljo31/Lens/LensParams/ReMass_2src_ksize',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/sizemass_2src_inferredage_wideprior_ksize'
f = open(outFile,'wb')
...
np.save('/data/ljo31/Lens/Analysis/sizemass_2src_fit_ksize',np.column_stack((xfit,yfit,lo,up)))
