...
X=6 - new_3 on bigger cutout - does it make a difference?
X=7 - gui_5. This is a reguied version of X=5, which might be maybe promising!'''
...
guiFile = '/data/ljo31/Lens/J2228/gui_5'
