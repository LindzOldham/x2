...
S = myEmcee.Emcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=64)
S.sample(1000)
outFile = '/data/ljo31/Lens/J1125/emcee_finishoff'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(20):
    S = myEmcee.Emcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=64,initialPars=trace[-1])
    S.sample(1000)

    outFile = '/data/ljo31/Lens/J1125/emcee_finishoff_'+str(X)
    f = open(outFile,'wb')
    cPickle.dump(S.result(),f,2)
    f.close()
