...
result = np.load('/data/ljo31/Lens/J1606/emcee6')
lp= result[0]
a2=0.
...
pars = []
cov = []
pars.append(pymc.Uniform('xoffset',-5.,5.,value=offsets[0][3]))#dic['xoffset'][a1,a2,a3]))
pars.append(pymc.Uniform('yoffset',-5.,5.,value=offsets[1][3]))#=dic['yoffset'][a1,a2,a3]))
cov += [0.2,0.2]
...
cov.append(0.05)
p['b'] = pars[-1]
pars.append(pymc.Uniform('extShear PA',-180.,180,value=shear[0]['pa']['value']))#dic['extShear PA'][a1,a2,a3]))
cov.append(100.)
p['pa'] = pars[-1]
...
#pars.append(pymc.Uniform('boxiness',1.,5,value=2.5))
#cov += [0.4]
...
S.sample(1000)
outFile = '/data/ljo31/Lens/J1606/emcee_nonboxy_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(30):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=56,ntemps=3,initialPars=trace[-1])
    S.sample(1000)
