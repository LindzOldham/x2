...
#sig1 = py.open('/data/ljo31/Lens/J1248/sig1_maskdust7.fits')[0].data.copy()[10:-10,20:-25]
...
guiFile = '/data/ljo31/Lens/J1248/V_december'
print guiFile

result = np.load('/data/ljo31/Lens/J1248/V_1')
...
print 'made it?'
S.sample(1000)
outFile = '/data/ljo31/Lens/J1248/V_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=52,ntemps=3,initialPars=trace[-1])
    S.sample(1000)
