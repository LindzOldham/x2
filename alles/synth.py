...
for name in names:
    ...
    corrI,corrV,corrK = i_src-I, v_src-V,k_src-K
    corr = np.mean((corrI,corrV,corrK))
    #print name, g+corr, r+corr, i+corr
    G,R,I = g+corr, r+corr, i+corr
    if G < 22.2 and R<22.2 and I<21.3:
        print name, 'observed'
    elif G<22.2 and R<22.2 and I>21.3:
        print name, 'observed in G and R'
    elif G<22.2 and R>22.2 and I<21.3:
        print name, 'observed in G and I'
    elif G>22.2 and R<22.2 and I<21.3:
        print name, 'observed in R and I'
