...
Vcut = V[2050-150:2050+150,3245-150:3245+150]#
#Vcut[Vcut<-1] = 0
pl.figure()
...
V_wht_cut = V_wht[2050-150:2050+150,3245-150:3245+150]#[2050-70:2050+70,3245-70:3245+70]#[2050-50:2050+50,3245-50:3245+50]
#Vcut[Vcut<-1] = 0
pl.figure()
pl.imshow(np.log10(V_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F555W_sci_cutout_huge.fits',Vcut,header,clobber=True)
py.writeto('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F555W_wht_cutout_huge.fits',V_wht_cut,header_wht,clobber=True)
...
Icut = I[2050-150:2050+150,3245-150:3245+150]#[2050-70:2050+70,3245-70:3245+70]#[2050-50:2050+50,3245-50:3245+50]
pl.figure()
...
I_wht_cut = I_wht[2050-150:2050+150,3245-150:3245+150]#[2050-70:2050+70,3245-70:3245+70]#[2050-50:2050+50,3245-50:3245+50]
pl.figure()
pl.imshow(np.log10(I_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F814W_sci_cutout_huge.fits',Icut,header,clobber=True)
py.writeto('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F814W_wht_cutout_huge.fits',I_wht_cut,header_wht,clobber=True)
