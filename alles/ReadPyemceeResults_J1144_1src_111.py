...
def NotPlicely(image,im,sigma):
    ...
    pl.title('model')
    pl.subplot(223)
    pl.imshow(image-im,origin='lower',interpolation='nearest',extent=ext,vmin=-0.25,vmax=0.25,cmap='afmhot_r',aspect='auto')
    pl.colorbar()
    pl.title('data-model')
    pl.subplot(224)
    pl.imshow((image-im)/sigma,origin='lower',interpolation='nearest',extent=ext,vmin=-5,vmax=5,cmap='afmhot_r',aspect='auto')
...
result = np.load('/data/ljo31/Lens/J1144/emcee_1src0')
lp= result[0]
a2=0.
