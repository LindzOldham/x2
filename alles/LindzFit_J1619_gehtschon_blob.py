...
p={}
name = 'blob'
pars.append(pymc.Uniform('blob x',35,45,value=40.))
pars.append(pymc.Uniform('blob y',35,45,value=41.))
pars.append(pymc.Uniform('blob b',0.05,2,value=0.2))
pars.append(pymc.Uniform('blob eta', 0.5,1.1,value=1.))
