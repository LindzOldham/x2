...
guiFile = '/data/ljo31/Lens/J1606/gui_1_2src_USE'
...
def logP(value=0.,p=pars):
    ...
    for i in range(len(imgs)):
        ...
        for gal in gals:
            gal.setPars()
            tmp = xc*0.
            tmp[mask2] = gal.boxypixeval(xin,yin,1./OVRS,csub=11) # evaulate on the oversampled grid. OVRS = number of new pixels per old pixel.
        ...
        for src in srcs:
            ...
            if src.pars['q'].value<0.2:
                ...
                tmp[mask2] = src.boxypixeval(x0,y0,1./OVRS,csub=11)
