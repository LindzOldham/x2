...
V_wht_cut = V_wht[2345:2515,1845:2015]
...
# save both
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_sci_cutout_bigger.fits',Vcut,header,clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_wht_cutout_bigger.fits',V_wht_cut,header_wht,clobber=True)
...
Icut = I[2345:2515,1845:2015] # small
...
I_wht_cut = I_wht[2345:2515,1845:2015] # small

pl.figure()
pl.imshow(np.log10(I_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_sci_cutout_bigger.fits',Icut,header,clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_wht_cutout_bigger.fits',I_wht_cut,header_wht,clobber=True)
