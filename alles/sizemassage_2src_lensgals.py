...
lumtab = py.open('/data/ljo31/Lens/LensParams/Lensinggalaxies_Lumb_ages_2src.fits')[1].data
lumtab2 = py.open('/data/ljo31/Lens/LensParams/Lensinggalaxies_Lumb_ages_1src.fits')[1].data
