...
im = py.open('/data/ljo31/Lens/J1125/F606W_sci_cutout_huge2.fits')[0].data.copy()
wht = py.open('/data/ljo31/Lens/J1125/F606W_wht_cutout_huge2.fits')[0].data.copy()
...
py.writeto('/data/ljo31/Lens/J1125/F606W_noisemap_huge2.fits',noisemap,clobber=True)
pl.figure()
...
from scipy import ndimage
im = py.open('/data/ljo31/Lens/J1125/F814W_sci_cutout_huge2.fits')[0].data.copy()
wht = py.open('/data/ljo31/Lens/J1125/F814W_wht_cutout_huge2.fits')[0].data.copy()
...
## save
py.writeto('/data/ljo31/Lens/J1125/F814W_noisemap_huge2.fits',noisemap,clobber=True)
pl.figure()
pl.imshow(noisemap,origin='lower',interpolation='nearest')
pl.colorbar()
