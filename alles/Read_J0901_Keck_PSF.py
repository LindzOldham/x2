...
kresult = np.load('/data/ljo31/Lens/J0901/KeckPSF_1')
klp= kresult[0]
ka2=0
...
xc,xo,yc,yo = xc+10,xo+10,yc+10,yo+10
...
xoffset,yoffset,sig1,q1,pa1,amp1,sig2,q2,pa2,dx1,dy1,dx2,dy2 = ktrace[ka1,ka2,ka3]
amp2=1.-amp1
psfObj1 = SBObjects.Gauss('psf 1',{'x':dx1,'y':dy1,'sigma':sig1,'q':q1,'pa':pa1,'amp':10})
psfObj2 = SBObjects.Gauss('psf 2',{'x':dx2,'y':dy2,'sigma':sig2,'q':q2,'pa':pa2,'amp':10})
...
print '%.2f'%dx,'%.2f'%dy,'%.2f'%sig1,'%.2f'%q1,'%.2f'%pa1,'%.2f'%dx1,'%.2f'%dy1,'%.2f'%amp1,'%.2f'%sig2,'%.2f'%q2,'%.2f'%pa2,'%.2f'%dx2,'%.2f'%dy2
