...
guiFile = '/data/ljo31/Lens/J1218/model7'
...
mask= py.open('/data/ljo31/Lens/J1218/mask.fits')[0].data.copy()[10:-10,10:-10]
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=14,nwalkers=70,ntemps=3)
S.sample(1000)
outFile = '/data/ljo31/Lens/J1218/emcee'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=14,nwalkers=70,ntemps=3,initialPars=trace[a1])
    S.sample(1000)
