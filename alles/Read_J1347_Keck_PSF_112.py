...
kresult = np.load('/data/ljo31/Lens/J1347/KeckPSF_3')
klp= kresult[0]
ka2=0
...
xoffset,yoffset,sig1,q1,pa1,amp1,sig2,q2,pa2,amp2,sig3,q3,pa3,amp3,sig4,q4,pa4,amp4,sig5,q5,pa5,amp5,sig6,q6,pa6,amp6 = ktrace[ka1,ka2,ka3]
...
print '%.2f'%sig6,'&','%.2f'%q6,'&','%.2f'%pa6,'&','%.2f'%amp6, r'\\'
