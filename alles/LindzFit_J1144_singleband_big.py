...
guiFile = '/data/ljo31/Lens/J1144/s2'
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=10,nwalkers=70,ntemps=4)
S.sample(1000)
...
jj=0
for jj in range(15):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=10,nwalkers=70,ntemps=4,initialPars=trace[-1])
    S.sample(1000)
