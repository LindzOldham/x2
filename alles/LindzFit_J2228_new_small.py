...
X =2
X = 3 # cutout made smaller - new_small.py!
print X
...
img1 = py.open('/data/ljo31/Lens/J2228/F555W_sci_cutout.fits')[0].data.copy()[160:-150,65:-65]#[120:-110,25:-25]        
sig1 = py.open('/data/ljo31/Lens/J2228/F606W_noisemap.fits')[0].data.copy()[160:-150,65:-65]#[120:-110,25:-25]    
psf1 = py.open('/data/ljo31/Lens/J2228/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)

img2 = py.open('/data/ljo31/Lens/J2228/F814W_sci_cutout.fits')[0].data.copy()[160:-150,65:-65]#[120:-110,25:-25]   
sig2 = py.open('/data/ljo31/Lens/J2228/F814W_noisemap.fits')[0].data.copy()[160:-150,65:-65]#[120:-110,25:-25]      
psf2 = py.open('/data/ljo31/Lens/J2228/F814W_psf1.fits')[0].data.copy()
psf2 = psf2/np.sum(psf2)

guiFile = '/data/ljo31/Lens/J2228/new1'
...
mask = py.open('/data/ljo31/Lens/J2228/mask.fits')[0].data.copy()[160:-150,65:-65]#[120:-110,25:-25] 
...
S.sample(1000)
outFile = '/data/ljo31/Lens/J2228/new_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=64,ntemps=3,initialPars=trace[-1])
    S.sample(1000)
