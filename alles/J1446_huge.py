...
Vcut = V[3790-150:3790+150,3745-150:3745+150]#
#Vcut[Vcut<-1] = 0
pl.figure()
...
V_wht_cut = V_wht[3790-150:3790+150,3745-150:3745+150]#[3760:3820,3710:3780]
#Vcut[Vcut<-1] = 0
pl.figure()
pl.imshow(np.log10(V_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/J1446/F606W_sci_cutout_huge.fits',Vcut,header,clobber=True)
py.writeto('/data/ljo31/Lens/J1446/F606W_wht_cutout_huge.fits',V_wht_cut,header_wht,clobber=True)
...
Icut = I[3790-150:3790+150,3745-150:3745+150]#[3760:3820,3710:3780]
pl.figure()
...
I_wht_cut = I_wht[3790-150:3790+150,3745-150:3745+150]#[3760:3820,3710:3780]
pl.figure()
pl.imshow(np.log10(I_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/J1446/F814W_sci_cutout_huge.fits',Icut,header,clobber=True)
py.writeto('/data/ljo31/Lens/J1446/F814W_wht_cutout_huge.fits',I_wht_cut,header_wht,clobber=True)
