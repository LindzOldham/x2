...
sig2 = py.open('/data/ljo31/Lens/J0901/F814W_noisemapedited3.fits')[0].data.copy()
psf2 = py.open('/data/ljo31/Lens/J0901/F814W_psf2.fits')[0].data.copy() # original psf
psf2 = psf2[4:-6,3:-6]
...
S = myEmcee.Emcee(pars+[likelihood],cov=optCov,nwalkers=100,nthreads=10) # should have 100 walkers.
S.sample(5000)

outFile = '/data/ljo31/Lens/J0901/emcee_final_'+str(X)
f = open(outFile,'wb')
