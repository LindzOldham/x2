...
ages,lvs,masses,model_vk,model_vi,mlvs = np.load('/data/ljo31/Lens/Analysis/InferredAges_1src_all.npy')
# check order there!!!
...
np.save('/data/ljo31/Lens/LensParams/ReMass_1src',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
