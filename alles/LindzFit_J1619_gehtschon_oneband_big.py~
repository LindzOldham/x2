...
sig1 = py.open('/data/ljo31/Lens/J1619/F606W_noisemap.fits')[0].data.copy()[30:-38,25:-30]*2.
...
jj=0
for jj in range(30):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=52,ntemps=3,initialPars=trace[-1])
    S.sample(1000)
