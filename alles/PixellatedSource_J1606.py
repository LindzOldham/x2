...
for name in ['Source 1','Source 2']:
    ...
    if name == 'Source 1':
        ...
        for key in 'q','re','n','pa':
            p[key] = dic[name+' '+key][a1,a2,a3]#s[key]['value']
        for key in 'x','y':
            p[key] = dic[name+' '+key][a1,a2,a3] + lenses[0].pars[key] #srcs[0].pars[key]
...
for i in range(len(imgs)):
    ...
    py.writeto('/data/ljo31/Lens/J1606/galsub_'+str(i)+'.fits',galim,clobber=True)
...
#pl.imshow(galsubs[1])
# and a mask
mask = py.open('/data/ljo31/Lens/J1606/maskforpix.fits')[0].data.copy()[20:-20,20:-40] - py.open('/data/ljo31/Lens/J1606/maskforpix3.fits')[0].data.copy()[20:-20,20:-40]
mask = mask==1
