...
'''x=0 - 1src_3
x=1 - same, but with psf3 not psf2
X=2 - with psf1new
X=3 - continuing X=2 as it needed a bit longer
X=4 - finishing off X=3'''
X=4
print X
# plot things
...
guiFile = '/data/ljo31/Lens/J1605/1src_3' # or use 1src_2!

result = np.load('/data/ljo31/Lens/J1605/emcee_1src3')
lp= result[0]
a2=0.
