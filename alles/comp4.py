...
pdf = np.load('/data/ljo31/Lens/PDFs/211_huge__J0913.npy')
rev,rei = pdf[-1].T
magv,magi = pdf[1].T
muv,mui = pdf[0].T
pdf2 = np.load('/data/ljo31/Lens/PDFs/211_huger__J0913.npy')
rev2,rei2 = pdf2[-1].T
