...
X=6 - not using mask7 or anything, but using the dustlanenew sig files
'''
...
sig1 = py.open('/data/ljo31/Lens/J0837/F606W_noisemap_dustlanenew5.fits')[0].data.copy()[15:-15,15:-15]
...
sig2 = py.open('/data/ljo31/Lens/J0837/F814W_noisemap_dustlanenew5.fits')[0].data.copy()[15:-15,15:-15]
...
jj=0
for jj in range(12):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=60,ntemps=3,initialPars=trace[a1])
    S.sample(1000)
