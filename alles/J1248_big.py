...
V_wht_cut = V_wht[2405:2610,3440:3650]#[2435:2580,3470:3620]
...
# save both
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F555W_sci_cutout_big.fits',Vcut,header,clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F555W_wht_cutout_big.fits',V_wht_cut,header_wht,clobber=True)
...
Icut = I[2405:2610,3440:3650]#[2435:2580,3470:3620]
...
I_wht_cut = I_wht[2405:2610,3440:3650]#[2435:2580,3470:3620]
