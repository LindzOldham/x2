...
X = 24 - gui_emcee19_3gals_uniform, allowing all galaxies to be offset with respect to each other RUNNING
X = 25 - gui_emcee19_3gals, allowing the third blob to move independently but the other two fixed RUNNING
X = 26 - gui_emcee19 - two gals, but allowed to move with respect to each other TO RUN
X = 27 - x23, but with sources also non-concentric! RUNNING
X = 28 - running gui_x23_f814w on the F814W image. See what it makes of it!
X = 35- F814W only, readytostart8, OVRS=2.
X = 36 - F814W only, readytostart7, OVRS=2.
'''
...
guiFile = '/data/ljo31/Lens/J0901/readytostart7'
...
maskX = py.open('/data/ljo31/Lens/J0901/mask_middler.fits')[0].data.copy()
