...
def NotPlicely(image,im,sigma,colour):
    ...
    pl.colorbar()
    py.writeto('/data/ljo31/Lens/J1619/resid'+str(colour)+'.fits',(image-im)/sigma,clobber=True)
    py.writeto('/data/ljo31/Lens/J1619/model'+str(colour)+'.fits',im,clobber=True)
...
print guiFile
X=10
result = np.load('/data/ljo31/Lens/J1619/emcee_restart'+str(X))
...
oldresult = np.load('/data/ljo31/Lens/J1619/emcee_restart5')
oldlp= result[0]
...
for name in L.keys():
    ...
    for key in 'q','pa','b','eta','x','y':
        p[key] = olddic[name+' '+key][olda1,olda2,olda3]
    lenses.append(MassModels.PowerLaw(name,p))
p = {}
p['x'] = lenses[0].pars['x']
p['y'] = lenses[0].pars['y']
p['b'] = olddic['extShear'][olda1,olda2,olda3]
p['pa'] = olddic['extShear PA'][olda1,olda2,olda3]
...
x4,y4,b,eta,pa4,q4 = olddic['Lens 1 x'][olda1,olda2,olda3], olddic['Lens 1 y'][olda1,olda2,olda3], olddic['Lens 1 b'][olda1,olda2,olda3], olddic['Lens 1 eta'][olda1,olda2,olda3], olddic['Lens 1 pa'][olda1,olda2,olda3], olddic['Lens 1 q'][olda1,olda2,olda3]
shear,shearpa = olddic['extShear'][olda1,olda2,olda3], olddic['extShear PA'][olda1,olda2,olda3]
