...
def NotPlicitly(image, im, sigma):
    ext = [0,image.shape[0],0,image.shape[1]]
    pl.figure()
    pl.subplot(131)
...
guiFile = '/data/ljo31/Lens/J1125/gui_29b_C'
...
#pl.figure()
#pl.imshow(srcs1+srcs2, interpolation='nearest',origin='lower',cmap='afmhot')
#pl.figure()
#pl.subplot(121)
...
x5,y5 = dic['Source 2 x'][a1,a2,a3], dic['Source 2 y'][a1,a2,a3]
