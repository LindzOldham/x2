...
from pointSource_edit import PixelizedModel as PM, GaussianModel as GM
from math import pi
...
class SBObject:
    ...
    def __setattr__(self,key,value):
        if key=='keys':
            ...
            elif key in self.keys and key in self.__dict__.keys():
...
class Lorentz(SBObject,SBProfiles.Lorentz):
    _baseProfile = SBProfiles.Lorentz
    _SBkeys = [['amp','pa','q','scale','x','y']]
...
class Stretch(SBObject,SBProfiles.Stretch):
    _baseProfile = SBProfiles.Stretch
    _SBkeys = [['amp','index','pa','q','scale','stretch','x','y']]
