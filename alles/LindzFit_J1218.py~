...
X=0 - model3 2/1/1
X=1 - model8 2/1/2
X=2 - gui_0 - an iterated version of X=0 - this got overwritten, oops. But oh well, mabes it doesn't matter!
WE ALSO NEED TO RESTART X=0 BECAUSE LP WAS STILL INCREASING A LOT
'''
...
guiFile = '/data/ljo31/Lens/J2228/gui_0'
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=60,ntemps=3,initialPars=trace[a1])
    S.sample(1000)
