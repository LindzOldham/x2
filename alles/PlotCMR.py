...
table_k = py.open('/data/ljo31/Lens/LensParams/KeckPhot_1src_nomult.fits')[1].data
...
table_k = py.open('/data/ljo31/Lens/LensParams/KeckLumk_ages_1src_nomult.fits')[1].data
...
age_cols,vi_mod, vk_mod = np.loadtxt('/data/mauger/STELLARPOP/salpeter/bc2003_lr_m62_salp_ssp.2color',unpack=True,usecols=(0,5,7))
age_mls, ml_b, ml_v = np.loadtxt('/data/mauger/STELLARPOP/salpeter/bc2003_lr_m62_salp_ssp.4color',unpack=True,usecols=(0,4,5))
...
pl.figure()
pl.scatter(v[ii],vi[ii])
pl.figure()
pl.scatter(i[ii],vi[ii])
pl.figure()
pl.scatter(v[ii],vk[ii])
