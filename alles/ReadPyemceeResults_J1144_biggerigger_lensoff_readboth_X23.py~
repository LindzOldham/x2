...
result = np.load('/data/ljo31/Lens/J1144/emcee_restart23')
...
oldresult = np.load('/data/ljo31/Lens/J1144/emcee15')
olddic = oldresult[2]
oldlp=oldresult[0]
...
cPickle.dump([G,L,S,offsets,[guishear,True]],open('/data/ljo31/Lens/J1144/UpdatedGuiFile_23','wb'))
