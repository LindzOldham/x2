...
X = 10 - gui_emcee3_both_2gals TO RUN NEXT
'''
...
guiFile = '/data/ljo31/Lens/J1144/gui_emcee3_2gals2'
...
jj=0
for jj in range(15):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=10,nwalkers=80,ntemps=4,initialPars=trace[-1])
    S.sample(1000)
