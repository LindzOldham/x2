...
xc,xo,yc,yo=xc+20,xo+20 , yc+20 , yo+20 
mask = py.open('/data/ljo31/Lens/J1144/mask606.fits')[0].data[25:-35,35:-30]- py.open('/data/ljo31/Lens/J1144/mask606holes.fits')[0].data[25:-35,35:-30] 
...
guiFile = '/data/ljo31/Lens/J1144/model2'
...
# and a mask
mask = py.open('/data/ljo31/Lens/J1144/mask4pix5.fits')[0].data.copy()[20:-20,20:-20]
print mask.shape
mask = mask==1
...
src.update(xl,yl)
osrc = showRes(xl,yl,src,PSFm,img,sig,mask,ifltm,vfltm,cmatm,1e-3,1,400)
pylab.show()
