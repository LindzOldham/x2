...
im = py.open('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F555W_sci_cutout_huge.fits')[0].data.copy()
wht = py.open('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F555W_wht_cutout_huge.fits')[0].data.copy()
...
py.writeto('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F555W_noisemap_huge.fits',noisemap,clobber=True)
pl.figure()
...
from scipy import ndimage
im = py.open('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F814W_sci_cutout_huge.fits')[0].data.copy()
wht = py.open('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F814W_wht_cutout_huge.fits')[0].data.copy()
...
## save
py.writeto('/data/ljo31/Lens/J1323/SDSSJ1323+3946_F814W_noisemap_huge.fits',noisemap,clobber=True)
pl.figure()
pl.imshow(noisemap,origin='lower',interpolation='nearest')
pl.colorbar()
