...
srcs = []
# galaxy 1
pars.append(pymc.Uniform('Galaxy 1 x',40.,50.,value=dic['Galaxy 1 x'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 1 y',45.,55.,value=dic['Galaxy 1 y'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 1 q',0.1,1.,value=dic['Galaxy 1 q'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 1 pa',-180.,180.,value=dic['Galaxy 1 pa'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 1 re',0.5,100.,value=dic['Galaxy 1 re'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 1 n',0.5,8.,value=dic['Galaxy 1 n'][a1,a2,a3]))
print '1'
gals.append(SBModels.Sersic('Galaxy 1',{'x':pars[-6],'y':pars[-5],'q':pars[-4],'pa':pars[-3],'re':pars[-2],'n':pars[-1]}))
cov += [0.1,0.1,0.1,50.,5.,0.5]
### galaxy 2
pars.append(pymc.Uniform('Galaxy 2 x',40.,50.,value=dic['Galaxy 2 x'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 y',45.,55.,value=dic['Galaxy 2 y'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 q',0.1,1.,value=dic['Galaxy 2 q'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 pa',-180.,180.,value=dic['Galaxy 2 pa'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 re',0.5,100.,value=dic['Galaxy 2 re'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 n',0.5,8.,value=dic['Galaxy 2 n'][a1,a2,a3]))
print '2'
gals.append(SBModels.Sersic('Galaxy 2',{'x':pars[-6],'y':pars[-5],'q':pars[-4],'pa':pars[-3],'re':pars[-2],'n':pars[-1]}))
cov += [0.1,0.1,0.1,50.,5.,0.5]
# lens 1
pars.append(pymc.Uniform('Lens 1 x',40.,50.,value=dic['Lens 1 x'][a1,a2,a3]))
pars.append(pymc.Uniform('Lens 1 y',45.,55.,value=dic['Lens 1 y'][a1,a2,a3]))
pars.append(pymc.Uniform('Lens 1 q',0.1,1.,value=dic['Lens 1 q'][a1,a2,a3]))
pars.append(pymc.Uniform('Lens 1 pa',-180.,180.,value=dic['Lens 1 pa'][a1,a2,a3]))
pars.append(pymc.Uniform('Lens 1 b',5.,15.,value=dic['Lens 1 b'][a1,a2,a3]))
pars.append(pymc.Uniform('Lens 1 eta',0.5,1.5,value=dic['Lens 1 eta'][a1,a2,a3]))
print '3'
...
pars.append(pymc.Uniform('extShear',-0.1,0.1,value=dic['extShear'][a1,a2,a3]))
lenses.append(MassModels.ExtShear('Shear',{'x':lenses[0].pars['x'],'y':lenses[0].pars['y'],'pa':pars[-2],'b':pars[-1]}))
cov += [50.,0.1]
# source 1
pars.append(pymc.Uniform('Source 1 x',42.,52.,value=dic['Source 1 x'][a1,a2,a3]))
pars.append(pymc.Uniform('Source 1 y',47.,57.,value=dic['Source 1 y'][a1,a2,a3]))
pars.append(pymc.Uniform('Source 1 q',0.1,1.,value=dic['Source 1 q'][a1,a2,a3]))
pars.append(pymc.Uniform('Source 1 pa',-180.,180.,value=dic['Source 1 pa'][a1,a2,a3]))
pars.append(pymc.Uniform('Source 1 re',0.5,100.,value=dic['Source 1 re'][a1,a2,a3]))
pars.append(pymc.Uniform('Source 1 n',0.5,10.,value=dic['Source 1 n'][a1,a2,a3]))
srcs.append(SBModels.Sersic('Source 1',{'x':pars[-6],'y':pars[-5],'q':pars[-4],'pa':pars[-3],'re':pars[-2],'n':pars[-1]}))
cov += [0.1,0.1,0.1,50.,1.,0.5]
# source 2
pars.append(pymc.Uniform('Source 2 x',42.,52.,value=dic['Source 2 x'][a1,a2,a3]))
pars.append(pymc.Uniform('Source 2 y',47.,57.,value=dic['Source 2 y'][a1,a2,a3]))
pars.append(pymc.Uniform('Source 2 q',0.1,1.,value=dic['Source 2 q'][a1,a2,a3]))
...
pars.append(pymc.Uniform('Source 2 n',0.5,10.,value=dic['Source 2 n'][a1,a2,a3]))
...
import time
start=time.time()
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=80,ntemps=4,initialPars=trace[-1])
S.sample(1000)
