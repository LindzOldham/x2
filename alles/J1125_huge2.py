...
V_wht_cut = V_wht[3495:3855,3690:4050]#[3595:3755,3790:3950]#[3605:3745,3800:3940]#[3630:3720,3825:3915]
#Vcut[Vcut<-1] = 0
pl.figure()
pl.imshow(np.log10(V_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/J1125/F606W_sci_cutout_huge2.fits',Vcut,header,clobber=True)
py.writeto('/data/ljo31/Lens/J1125/F606W_wht_cutout_huge2.fits',V_wht_cut,header_wht,clobber=True)
...
Icut = I[3495:3855,3690:4050]#[3595:3755,3790:3950]#[3605:3745,3800:3940]#[3630:3720,3825:3915]
pl.figure()
...
I_wht_cut = I_wht[3495:3855,3690:4050]#[3595:3755,3790:3950]#[3605:3745,3800:3940]#[3630:3720,3825:3915]
pl.figure()
pl.imshow(np.log10(I_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/J1125/F814W_sci_cutout_huge2.fits',Icut,header,clobber=True)
py.writeto('/data/ljo31/Lens/J1125/F814W_wht_cutout_huge2.fits',I_wht_cut,header_wht,clobber=True)
