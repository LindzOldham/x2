...
X=1
X=2 # starting off from the Keck model...!
print X
''' new!!! '''
...
lenscovs = dict([('x',0.5),('y',0.5),('q',0.05),('pa',1.),('b',0.1),('eta',0.1)])
...
import time
start=time.time()
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=52,ntemps=3)
S.sample(1000)
...
jj=0
for jj in range(30):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=52,ntemps=3,initialPars=trace[-1],filename='/data/ljo31/Lens/J1619/chain_'+str(X))
    S.sample_save(1000)
