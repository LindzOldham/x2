...
'''
X=5 # fitting for positions in source plane as well as le psf!
X=6 # as 5, but with ovrs=3
X=8
print X
print 'here'
# plot things
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=44,ntemps=3)
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=44,ntemps=3,initialPars=trace[a1])
    S.sample(500)
