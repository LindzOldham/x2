...
img1 = py.open('/data/ljo31/Lens/J1144/F606W_sci_cutout.fits')[0].data.copy()[10:-10,10:-10]
sig1 = py.open('/data/ljo31/Lens/J1144/F606W_noisemap.fits')[0].data.copy()[10:-10,10:-10]
psf1 = py.open('/data/ljo31/Lens/J1144/F606W_psf1.fits')[0].data.copy()
psf1 = psf1/np.sum(psf1)

img2 = py.open('/data/ljo31/Lens/J1144/F814W_sci_cutout.fits')[0].data.copy()[10:-10,10:-10]
sig2 = py.open('/data/ljo31/Lens/J1144/F814W_noisemap.fits')[0].data.copy()[10:-10,10:-10]
