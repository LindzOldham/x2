...
cut1 = sci[2400:2465,1990:2035]
cut2 = sci[2500:2525,1915:1965]
cut3 = sci[2400:2445,1840:1875]

wht1 = wht[2400:2465,1990:2035]
wht2 = wht[2500:2525,1915:1965]
wht3 = wht[2400:2445,1840:1875]
...
im = py.open('/data/ljo31/Lens/'+str(name[:5])+'/F606W_sci_cutout_biggerigger.fits')[0].data.copy()
wht = py.open('/data/ljo31/Lens/'+str(name[:5])+'/F606W_wht_cutout_biggerigger.fits')[0].data.copy()
...
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_noisemap_biggerigger.fits',noisemap,clobber=True)
pl.figure()
...
from scipy import ndimage
im = py.open('/data/ljo31/Lens/'+str(name[:5])+'/F814W_sci_cutout_biggerigger.fits')[0].data.copy()
wht = py.open('/data/ljo31/Lens/'+str(name[:5])+'/F814W_wht_cutout_biggerigger.fits')[0].data.copy()
...
## save
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_noisemap_biggerigger.fits',noisemap,clobber=True)
pl.figure()
pl.imshow(noisemap,origin='lower',interpolation='nearest')
pl.colorbar()
