...
dxx,dyy,dzz = dsigmas/sigmas/np.log(10.), dmu, 0.1*dre/re/np.log(10.)
...
S.sample(6000)
outFile = '/data/ljo31b/EELs/FP/inference/src1mu'
f = open(outFile,'wb')
cPickle.dump(S.result(),f,2)
f.close()
result = S.result()
result = np.load('/data/ljo31b/EELs/FP/inference/src1mu')
...
pl.title('EELs')
pl.savefig('/data/ljo31b/EELs/esi/TeX/eelsFPmu222.pdf')
pl.show()
