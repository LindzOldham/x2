...
ages,lvs,masses,model_vk,model_vi,mlvs = np.load('/data/ljo31/Lens/Analysis/LensgalInferredAges_2src_all.npy')
# check order there!!!
...
np.save('/data/ljo31/Lens/LensParams/ReMass_lensgals_2src',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/sizemass_2src_inferredage_lensgals'
f = open(outFile,'wb')
