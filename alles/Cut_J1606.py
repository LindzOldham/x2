...
V = py.open('/data/ljo31/Lens/J1606/SDSSJ1606+2235_F606W_sci.fits')[0].data.copy()
...
#''' psf '''
psf = V[1369-25:1369+25,2498-22:2498+23]
psf = psf/np.sum(psf)
py.writeto('/data/ljo31/Lens/J1606/SDSSJ1606+2235_F606W_psf.fits',psf,clobber=True)
...
I = py.open('/data/ljo31/Lens/J1605/SDSSJ1606+2235_F814W_sci.fits')[0].data.copy()
...
psf = I[1369-26:1369+25,2498-22:2498+22]
psf = psf/np.sum(psf)
