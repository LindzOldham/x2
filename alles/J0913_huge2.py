...
Vcut = V[2300:2550,1865:2110]#
Vcut = V[2250:2600,1815:2160]#
...
V_wht_cut = V_wht[2250:2600,1815:2160]#[2300:2550,1865:2110]#[2330:2520,1895:2080]#[2380:2470,1945:2030]
...
# save both
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F555W_sci_cutout_huge3.fits',Vcut,header,clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F555W_wht_cutout_huge3.fits',V_wht_cut,header_wht,clobber=True)
...
Icut = I[2250:2600,1815:2160]#[2300:2550,1865:2110]#[2330:2520,1895:2080]#[2380:2470,1945:2030]
...
I_wht_cut = I_wht[2250:2600,1815:2160]#[2300:2550,1865:2110]#[2330:2520,1895:2080]#[2380:2470,1945:2030]

pl.figure()
pl.imshow(np.log10(I_wht_cut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_sci_cutout_huge3.fits',Icut,header,clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_wht_cutout_huge3.fits',I_wht_cut,header_wht,clobber=True)
