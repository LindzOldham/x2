...
logRe,logM,dlogRe,dlogM,rho = np.load('/data/ljo31/Lens/LensParams/ReMass_1src.npy').T
...
np.save('/data/ljo31/Lens/Analysis/sizemass_1src_nuggets_fit',np.column_stack((xfit,yfit,lo,up)))
