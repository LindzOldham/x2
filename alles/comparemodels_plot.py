...
logRe,logM,dlogR,dlogM,rho = np.load('/data/ljo31/Lens/LensParams/ReMass_lensgals_2src_new.npy').T
logRe1,logM1,dlogR1,dlogM1,rho = np.load('/data/ljo31/Lens/LensParams/ReMass_lensgals_1src_new.npy').T
name = py.open('/data/ljo31/Lens/LensParams/Phot_1src.fits')[1].data['name']
