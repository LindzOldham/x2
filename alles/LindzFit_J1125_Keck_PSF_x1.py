...
'''
X=1
X=2 #- with hst-style noisemap. TO RUN
#X=3 #- with a CENTRED psf!
print X
...
cov += [50]
pars.append(pymc.Uniform('amp 1',0,1,value=0.4))
cov += [4]
...
cov += [50]
pars.append(pymc.Uniform('amp 2',0,1,value=0.4))
cov += [4]
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=26,ntemps=3,initialPars=trace[a1])
    S.sample(500)
