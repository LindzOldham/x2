...
logM,lo,hi = np.loadtxt('/data/ljo31/Lens/LensParams/src_mass_212_salpeter.dat').T
print logM
dM = np.mean((lo,hi))
...
for i in range(logM.size):
    ...
    np.save('/data/ljo31b/EELs/phys_models/models/interpolators/gNFW_gamma_12_LO_M_salpeter_'+name,obj)
