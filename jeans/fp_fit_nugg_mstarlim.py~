...
np.savetxt('/data/ljo31b/EELs/phys_models/FP_nuggets_100_scattered_1re_2.dat',[xx,yy,zz,dxx,dyy,dzz])
...
S.sample(3000)
outFile = '/data/ljo31b/EELs/inference/FP/jeansmodels_nugg_1re_2'
f = open(outFile,'wb')
