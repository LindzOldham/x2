...
re_norm, vd_norm, mu_norm = np.loadtxt('/data/ljo31b/EELs/phys_models/FP_normals_100_Mstarlim.dat').T
re_nugg, vd_nugg, mu_nugg = np.loadtxt('/data/ljo31b/EELs/phys_models/FP_nuggets_100_Mstarlim.dat').T
...
np.savetxt('/data/ljo31b/EELs/phys_models/FP_normals_100_scattered_1re_3.dat',[xx,yy,zz,dxx,dyy,dzz])
...
S.sample(4000)
outFile = '/data/ljo31b/EELs/inference/FP/jeansmodels_norm_1re_3'
f = open(outFile,'wb')
cPickle.dump(S.result(),f,2)
f.close()
result = S.result()'''
result = np.load('/data/ljo31b/EELs/inference/FP/jeansmodels_norm_1re_3')
