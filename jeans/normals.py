...
def run(Mstar=10.5,n=4.):
    ...
    # construct nugget
    kpc2cm = 3.086e21
    gal = SBObjects.Sersic('normal',{'x':0,'y':0,'re':re,'n':n,'q':1,'pa':0,'amp':1.})
    ...
    pl.xlim([0,5])
    #pl.ylim([160,230])
    pl.savefig('/data/ljo31/public_html/Lens/phys_models/synthetic_normals/n=2/Mstar_'+'%.2f'%Mstar+'_n_'+'%.2f'%n+'.pdf')
...
f=open('/data/ljo31/public_html/Lens/phys_models/synthetic_normals/n=2/cat','wb')
