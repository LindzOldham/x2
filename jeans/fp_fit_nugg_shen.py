...
S.sample(3000)
outFile = '/data/ljo31b/EELs/inference/FP/jeansmodels_nugg_2re_shen'
print outFile
f = open(outFile,'wb')
...
#result = np.load('/data/ljo31b/EELs/inference/FP/jeansmodels_nugg_1re_shen_1')
lp,trace,dic,_ = result
a1,a2 = np.unravel_index(lp.argmax(),lp.shape)
for i in range(len(pars)):
    pars[i].value = np.median(trace[2500:,:,i])
