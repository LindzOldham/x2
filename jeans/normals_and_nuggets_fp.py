...
def run(Mstar,n):
    ...
    sigma_dm_nugg = veldisp(r,sb_nugg,Mdm,ap=2.*gal_norm.re)
    sigma_star_norm = veldisp(r,sb_norm,Mlum_norm,ap=2.*gal_norm.re)      
    sigma_star_nugg = veldisp(r,sb_nugg,Mlum_nugg,ap=2.*gal_norm.re)  
...
np.savetxt('/data/ljo31b/EELs/phys_models/FP_normals_100_2renorm_Mstarlim.dat',cat_norm)
np.savetxt('/data/ljo31b/EELs/phys_models/FP_nuggets_100_2renorm_Mstarlim.dat',cat_nugg)
