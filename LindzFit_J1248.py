...
X = 99 # gui_100c - 3/1/1!
X=98 # gui_5b
X=96 # 2_12_15 with mask777 TO RUN
#X=95 # 2_12_15b with maskshoe RUNNING!
'''X=100 - seTup3'''
print X
...
sig2 = py.open('/data/ljo31/Lens/J1248/sig2_maskshoe.fits')[0].data.copy()[10:-10,10:-25] 
psf2 = py.open('/data/ljo31/Lens/J1248/F814W_psfnew.fits')[0].data.copy()
psf2=psf2/np.sum(psf2)
sig2 = py.open('/data/ljo31/Lens/J1248/sig2_mask777.fits')[0].data.copy()[10:-10,10:-25] 


guiFile = '/data/ljo31/Lens/J1248/2_12_15'
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=80,ntemps=3,initialPars=trace[a1])
    S.sample(1000)
