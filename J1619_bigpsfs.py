...
''' psfs! '''
psf1 = V[761-20:761+20,2899.5-20.5:2899.5+20.5]
psf1=psf1[:-1,:-2]
psf2 = V[3896-20:3896+20,2814.5-20.5:2814.5+20.5]
psf2 = psf2[:-1,:-2]
psf3 = V[4632-20:4632+20,2473-20:2473+20]
psf3 = psf3[:-1,:-2]
psf4 = V[1773.5-20.5:1773.5+20.5,1646.5-20.5:1646.5+20.5]
psf4=psf4[:-1,:-1]
...
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_psf1big.fits', psf1, clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_psf2big.fits', psf2, clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_psf3big.fits', psf3, clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_psf4big.fits', psf4, clobber=True)
...
''' PSF '''
psf1 = I[4631.5-20.5:4631.5+20.5,2471.5-20.5:2471.5+20.5]
psf1 = psf1[:-2,:-2]
psf2 = I[4309-20:4309+20,3368-20:3368+20]
psf2 = psf2[:,:-2]
psf3 = I[761-20:761+20,2898-20:2898+20]
psf3 = psf3[:-2,:-2]
psf4 = I[2535-20:2535+20,5293-20:5293+20]
psf4 = psf4[:-3,:-2]
psf1 = psf1/np.sum(psf1)
psf2 = psf2/np.sum(psf2)
psf3 = psf3/np.sum(psf3)
...
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_psf1big.fits', psf1, clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_psf2big.fits', psf2, clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_psf3big.fits', psf3, clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_psf4big.fits', psf4, clobber=True)
