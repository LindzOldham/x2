...
X = 10 - the first emcee, starting from the end of emcee5 (which was parallel tempered, despite the name....)
X = 13 - emceeing off the end of X = 11 (the ridicuouslt long run)
X = 15 - same as 13, but with OVRS = 2.
X = 22 - emceeing off the end of X = 12.
'''
X = 22
print X
...
#S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=12,nwalkers=60,ntemps=6,initialPars=trace[-1])
#S.sample(8000)
S = myEmcee.Emcee(pars+[likelihood],cov=optCov,nwalkers=60,nthreads=6,initialPars=trace[a1,a2]) # should have 100 walkers.
S.sample(6000)
