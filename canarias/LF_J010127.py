...
guiFile = '/data/ljo31b/lenses/lensmodel_A'
...
mask = py.open('/data/ljo31b/lenses/mask.fits')[0].data
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=32,nwalkers=44,ntemps=3)

'''
S.sample(500)
outFile = '/data/ljo31b/lenses/model_A_'+str(X)
f = open(outFile,'wb')
