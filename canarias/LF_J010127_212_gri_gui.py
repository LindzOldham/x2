...
X='gri_B_6' # starting from the gui again!# continuing gri_B_1, with slightly bigger image and better priors on re
# one source because the second source always insists on going stupid
print X
...
result = np.load('/data/ljo31b/lenses/model_gri_gri_B_2') # ouyr best so far -- the source is sensible, but maybe the galaxy isn't. Need more masking?
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=8,nwalkers=100,ntemps=3)
S.sample(500)
