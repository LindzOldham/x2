...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=40,ntemps=1)
S.sample(500)
outFile = '/data/ljo31/Lens/J0913/I_211_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=40,ntemps=1,initialPars=trace[a1])
    S.sample(500)
