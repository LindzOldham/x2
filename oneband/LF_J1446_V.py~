...
pars.append(pymc.Uniform('yoffset',-40.,40.,value=7.5))
cov += [0.4,0.4]
#psf1
...
los = dict([('q',0.05),('pa',-180.),('re',0.1),('n',0.2)])
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=52,ntemps=3)
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1446/Kp_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=52,ntemps=3,initialPars=trace[a1])
    S.sample(500)
