...
kresult = np.load('/data/ljo31/Lens/J1606/V_0')
klp= kresult[0]
ka2=0
...
for src in srcs:
    ...
    tmp = xc*0.
    if src.pars['q']<0.2:
        tmp[mask2] = src.boxypixeval(x0,y0,1./OVRS,csub=23,c=bar)
    else:
...
np.save('/data/ljo31/Lens/radgrads/J1606_112_V',srcs)#[0].pars,srcs[1].pars])
