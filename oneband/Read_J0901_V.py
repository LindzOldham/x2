...
def NotPlicely(image,im,sigma):
    ...
    pl.figure()
    pl.subplot(221)
    pl.imshow(image,origin='lower',interpolation='nearest',extent=ext,cmap='afmhot',aspect='auto',vmin=0,vmax=7.2) #,vmin=vmin,vmax=vmax)
    pl.colorbar()
    pl.title('data')
    pl.subplot(222)
...
kresult = np.load('/data/ljo31/Lens/J0901/V_0')
klp= kresult[0]
ka2=0
...
np.save('/data/ljo31/Lens/radgrads/J0901_211_V',srcs)
