...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=38,ntemps=1)
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1606/V_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(30):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=38,ntemps=1,initialPars=trace[-1])
    S.sample(500)
