...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=44,ntemps=1)
S.sample(500)
outFile = '/data/ljo31/Lens/J0837/V_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=44,ntemps=1,initialPars=trace[-1])
    S.sample(500)
