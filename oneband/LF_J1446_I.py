...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=52,ntemps=1)
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1446/I_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=52,ntemps=1,initialPars=trace[a1])
    S.sample(500)
