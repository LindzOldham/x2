...
result = np.load('/data/ljo31/Lens/J1248/emcee0')
lp= result[0]
a2=0.
...
xoffset =  offsets[0][3]
yoffset = offsets[1][3]
pars.append(pymc.Uniform('xoffset',-5.,5.,value=dic['xoffset'][a1,a2,a3]))#xoffset))
pars.append(pymc.Uniform('yoffset',-5.,5.,value=dic['yoffset'][a1,a2,a3]))#yoffset))
cov += [0.2,0.2]
