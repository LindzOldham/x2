...
S.sample(500)
outFile = '/data/ljo31/Lens/Analysis/1src_VKIage'
f = open(outFile,'wb')
...
'''
result = np.load('/data/ljo31/Lens/Analysis/1src_VKIage')
lp,trace,dic,_ = result
...
#masses,ages,lvs,iis,ks,mlvs,vs,lis,lks,mlbs = np.load('/data/ljo31/Lens/Analysis/InferredAges_1src_all.npy')
