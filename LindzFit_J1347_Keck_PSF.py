...
#X=0
X=1 # the 112 model!
X=5 # 112, ovrs=5, 6 psf components.
X='final'
print X
...
cov += [0.4,0.4]
#psf1
pars.append(pymc.Uniform('sigma 1',0.1,8,value=1))
pars.append(pymc.Uniform('q 1',0,1,value=0.7))
pars.append(pymc.Uniform('pa 1',-180,180,value= 90 ))
pars.append(pymc.Uniform('amp 1',0,1,value=0.15))
cov += [1,0.5,50,0.5]
# psf2
...
pars.append(pymc.Uniform('amp 2',0,1,value=0.15))
cov += [1,0.5,50,0.2]
# psf3
...
cov += [1,0.5,50,0.2]
# psf4
pars.append(pymc.Uniform('sigma 4',0.1,400,value= 15 ))
pars.append(pymc.Uniform('q 4',0,1,value=0.9))
pars.append(pymc.Uniform('pa 4',-180,180,value= 90 ))
pars.append(pymc.Uniform('amp 4',0,1,value=0.15))
cov += [1,0.5,50,0.2]
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=54,ntemps=3)
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1347/KeckPSF_'+str(X)
f = open(outFile,'wb')
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=54,ntemps=3,initialPars=trace[a1])
    S.sample(500)
