...
#cov += [50]
pars.append(pymc.Uniform('amp 1',0,1,value=0.3))
cov += [4]
pars.append(pymc.Uniform('sigma 2',0,30,value= 5 )) #30eb )) #15))
cov += [40]
...
cov += [4]
pars.append(pymc.Uniform('sigma 3',0,150,value= 80 )) #30eb )) #15))
cov += [40]
#pars.append(pymc.Uniform('q 3',0,1,value=0.9))
#cov += [1]
#pars.append(pymc.Uniform('pa 3',-180,180,value= 90 )) #-100 )) ##-100))
#cov += [100]
pars.append(pymc.Uniform('amp 3',0,1,value=0.3))
cov += [4]
