...
class PTEmcee:
    def __init__(self,pars,cov=None,nwalkers=None,ntemps=None,nthreads=2,initialPars=None,filename=None):
...
#            self.nwalkers = self.nwalkers+1
    ...
    def evidence(self,logl=None):
        if logl is not None:
            self.logl = logl
        self.lnZ = self.sampler.thermodynamic_integration_log_evidence()
        return self.lnZ
