...
X=10 - rerunning X=8 with ovrs=2.
X=11 - relaxing priors in X=10 on x0
X=13 - starting off the disk in a diferent place to see if we can find a better fit.
X=19 - going back to the exponential disk profile and trying thinner disks!
'''
...
result = np.load('/data/ljo31/Lens/J1446/emcee11')
lp= result[0]
a2=0.
...
pars.append(pymc.Uniform('Galaxy 2 xmax',0,100,value=dic['Galaxy 2 xmax'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 x',dic['Galaxy 2 x'][a1,a2,a3]-5,dic['Galaxy 2 x'][a1,a2,a3]+5,value=dic['Galaxy 2 x'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 y',dic['Galaxy 2 y'][a1,a2,a3]-5,dic['Galaxy 2 y'][a1,a2,a3]+5,value=dic['Galaxy 2 y'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 pa',-180,180.,value=dic['Galaxy 2 pa'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 x0',0,100,value=dic['Galaxy 2 x0'][a1,a2,a3]))
pars.append(pymc.Uniform('Galaxy 2 y0',0.2,5,value=dic['Galaxy 2 y0'][a1,a2,a3]))
cov += [0.5,1.,1.,5.,10.,0.5]
gals.append(SBBModels.Disk('Galaxy 2',{'x':pars[-5],'y':pars[-4],'pa':pars[-3],'x0':pars[-2],'y0':pars[-1],'xmax':pars[-6]}))
print gals[1].pars
