...
X=100 # going back down from 100 and we can meet in the middle!
X = 99 # gui_100c - 3/1/1!
X=98 # gui_5b
X=97 # K and V bands, gui_100c
'''X=100 - seTup3'''
print X
...
sig1 = py.open('/data/ljo31/Lens/J1248/sig1_addedagain3.fits')[0].data.copy()[10:-10,10:-25]
...
#sig2 = py.open('/data/ljo31/Lens/J1248/sig_ringmasked.fits')[0].data.copy()[10:-10,10:-25]
psf2 = psf2/np.sum(psf2)
sig2 = py.open('/data/ljo31/Lens/J1248/sig2_maskdust7.fits')[0].data.copy()[10:-10,10:-25]
sig2 = py.open('/data/ljo31/Lens/J1248/sig2_addedagain3.fits')[0].data.copy()[10:-10,10:-25] 
'''

img2 = py.open('/data/mauger/EELs/SDSSJ1248+4711/J1248_med.fits')[0].data.copy()[575:950,535:885]
sig2 = np.ones(img2.shape)
psf2 = py.open('/data/ljo31/Lens/J0837/PSF_nirc2_Kp_narrow.fits')[0].data.copy()[25:-25,25:-25]
psf2 = psf2/np.sum(psf2)

guiFile = '/data/ljo31/Lens/J1248/gui_100c'
...
yck,xck = iT.overSample(img2.shape,OVRS)
yok,xok = iT.overSample(img2.shape,1)
xok,xck=xok+150,xck+150
yok,yck=yok+110,yck+110
...
pars.append(pymc.Uniform('boxiness',0.5,4,value=2.))
cov.append(0.4)
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=70,ntemps=3)
S.sample(1000)
...
jj=0
for jj in range(20):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=18,nwalkers=70,ntemps=3,initialPars=trace[a1])
    S.sample(1000)
