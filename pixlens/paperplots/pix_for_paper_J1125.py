...
def showRes(x,y,src,psf,img,sig,mask,iflt,vflt,cmat,reg,niter,npix,vmx,band):
    ...
    rmat = src.rmat
    #reg = 0.05
    res,fit,model,rhs,regg = aT.getModelG(iflt,vflt,lmat,cmat,rmat,1.9,niter=niter)
    ...
    pl.imshow(osrc[100:-100,100:-100],origin='lower',interpolation='nearest',extent=ext,vmin=0,vmax=1.8,cmap='jet',aspect='auto')
