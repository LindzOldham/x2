...
result = np.load('/data/ljo31/Lens/J1144/KeckPSF_3')
lp= result[0]
a2=0
...
dx,dy,sig1,q1,pa1,amp1,sig2,amp2,sig3 = trace[a1,a2,a3]
amp3 = 1.-amp1-amp2
pa3,q3=0.,1.
pa2=0
gals = []
...
psf3 = psfObj2.pixeval(xpsf,ypsf) * amp3 / (np.pi*2.*sig3**2.)
psf = psf1 + psf2 + psf3
psf /= psf.sum()
...
pl.colorbar()
pl.figure()
pl.imshow(psf1+psf2+psf3,interpolation='nearest')
pl.colorbar()

print '%.2f'%dx,'%.2f'%dy,'%.2f'%sig1,'%.2f'%q1,'%.2f'%pa1,'%.2f'%amp1,'%.2f'%sig2
