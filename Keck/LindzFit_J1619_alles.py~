...
X=0 
X=1 # add more walkers and ovrs=1 
X=2 # negative bg component.
X=3 # fitting galaxy as well
X = 4
X = 6 # with bigger osf grid and more walkers - based on improvements when remodelling lens mass
X=7 # with sources moving independently
print X
