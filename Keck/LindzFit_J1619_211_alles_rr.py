...
X = 0 # 211
X = 1 # 211 fitting lens and gala nd everything!!!
X = 2 # continuing 1
print X
...
kresult = np.load('/data/ljo31/Lens/J1619/Kp_211_1')
klp= kresult[0]
ka2=0
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=30,nwalkers=100,ntemps=3)
...
jj=0
for jj in range(30):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=30,nwalkers=100,ntemps=3,initialPars=trace[-1])
    S.sample(500)
