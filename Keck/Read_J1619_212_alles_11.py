...
lresult = np.load('/data/ljo31/Lens/LensModels/J1619_Kp_211_lensandgalon')
llp= lresult[0]
la2=0
...
kresult = np.load('/data/ljo31/Lens/J1619/Kp_11')
klp= kresult[0]
ka2=0
...
pl.figure()
pl.imshow(np.log10(psf),interpolation='nearest',origin='lower')
pl.colorbar()
...
for name in ['Galaxy 1', 'Galaxy 2']:
    ...
    if name == 'Galaxy 1':
        for key in 'x','y','q','pa','re','n':
            p[key] = ldic[name+' '+key][la1,la2,la3]
    elif name == 'Galaxy 2':
...
for key in 'x','y','q','pa','b','eta':
    p[key] = ldic['Lens 1 '+key][la1,la2,la3]
