...
cov += [0.4,0.4]
#psf1
pars.append(pymc.Uniform('sigma 1',0,15,value=2.5))
...
cov +=[0.5,0.5,50,0.5]
# psf2
pars.append(pymc.Uniform('sigma 2',1,40 ,value= 4 )) 
...
cov +=[1,0.5,50,0.5]
# psf3
pars.append(pymc.Uniform('sigma 3',1,100,value= 10 )) 
...
S.sample(500)
outFile = '/data/ljo31/Lens/J1605/Kp_'+str(X)
f = open(outFile,'wb')
