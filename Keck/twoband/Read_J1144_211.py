...
kresult = np.load('/data/ljo31/Lens/J1144/twoband_Kp_211_0')
klp= kresult[0]
ka2=0
...
presult = np.load('/data/ljo31/Lens/LensModels/J1144_Kp_211')
pdic = presult[2]

for key in ['q 1','q 2','q 3','sigma 1','sigma 2','sigma 3']:
    pl.figure()
    pl.hist(kdic[key].ravel(),30,alpha=0.5,histtype='stepfilled')
