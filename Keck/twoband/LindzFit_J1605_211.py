...
cov += [0.4,0.4]
#psf1
pars.append(pymc.Uniform('sigma 1',0,15,value=3))
...
cov +=[0.5,0.5,50,0.5]
# psf2
pars.append(pymc.Uniform('sigma 2',1,40 ,value= 6 )) 
...
cov +=[1,0.5,50,0.5]
# psf3
pars.append(pymc.Uniform('sigma 3',1,100,value= 15 )) 
...
S.sample(500)
outFile = '/data/ljo31/Lens/J1605/twoband_Kp_211_'+str(X)
f = open(outFile,'wb')
