...
result = np.load('/data/ljo31/Lens/LensModels/twoband/J1606_212')
lp= result[0]
a2=0
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=54,ntemps=3)
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1606/twoband_Kp_212_'+str(X)
f = open(outFile,'wb')
