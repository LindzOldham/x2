...
pars.append(pymc.Uniform('q 1',0.05,1,value=0.7))
pars.append(pymc.Uniform('pa 1',-180,180,value= 90 ))
pars.append(pymc.Uniform('amp 1',0,1,value=0.1))
cov += [1,0.5,50,0.5]

# psf2
pars.append(pymc.Uniform('sigma 2',0.1,60,value= 5 )) 
pars.append(pymc.Uniform('q 2',0.05,1,value=0.9))
...
pars.append(pymc.Uniform('q 3',0.05,1,value=0.9))
pars.append(pymc.Uniform('pa 3',-180,180,value= 90 ))
pars.append(pymc.Uniform('amp 3',0,1,value=0.5))
cov += [1,0.5,50,0.5]
...
S = myEmcee.Emcee(pars+[logP,likelihood],cov=optCov,nthreads=22,nwalkers=44)#,ntemps=2)
S.sample_blobs(500)
outFile = '/data/ljo31/Lens/J0837/twoband_Kp_dl_'+str(X)
f = open(outFile,'wb')
...
for jj in range(20):
    ...
    outFile = '/data/ljo31/Lens/J0837/twoband_Kp_dl_blobs_'+str(X)
    f = open(outFile,'wb')
