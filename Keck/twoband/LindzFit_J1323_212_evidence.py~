...
kresult = np.load('/data/ljo31/Lens/J1323/twoband_Kp_212_1')
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=24,nwalkers=54,ntemps=3)
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1323/twoband_Kp_212_'+str(X)
f = open(outFile,'wb')
