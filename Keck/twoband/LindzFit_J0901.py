...
S = myEmcee.Emcee(pars+[logP,likelihood],cov=optCov,nthreads=24,nwalkers=40)
print 'set up sampler'
S.sample_blobs(500)

outFile = '/data/ljo31/Lens/J0901/twoband_Kp_'+str(X)
f = open(outFile,'wb')
...
for jj in range(10):
    ...
    outFile = '/data/ljo31/Lens/J0901/twoband_Kp_blobs_'+str(X)
    f = open(outFile,'wb')
