...
covs = dict([('x',0.5),('y',0.5),('q',0.1),('pa',1.),('re',1.),('n',1.)])
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=22,nwalkers=80,ntemps=3)
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1619/twoband_Kp_212_alles_'+str(X)
f = open(outFile,'wb')
