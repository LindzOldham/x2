...
rr = np.load('/data/ljo31/Lens/J1446/twoband_Kp_212_0')
tr=rr[1]

S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=6,nwalkers=52,ntemps=3,initialPars=tr[-1])
print 'set up sampler'
S.sample(500)
outFile = '/data/ljo31/Lens/J1446/twoband_Kp_212_'+str(X)
f = open(outFile,'wb')
