...
result = np.load('/data/ljo31/Lens/LensModels/twoband/J1144_212')
...
# psf3
pars.append(pymc.Uniform('sigma 3',0.1,400,value= 20 )) 
...
S.sample(500)
outFile = '/data/ljo31/Lens/J1144/twoband_Kp_212_'+str(X)
f = open(outFile,'wb')
