...
image = py.open('/data/ljo31/Lens/J1347/J1347_med.fits')[0].data.copy()[875:1055,885:1060]#[855:1075,865:1080]
...
xc,xo,yc,yo=xc-65,xo-65,yc-65,yo-65
...
kresult = np.load('/data/ljo31/Lens/J1347/twoband_Kp_112_1')#_ctd')
klp= kresult[0]
ka2=0
