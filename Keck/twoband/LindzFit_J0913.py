...
result = np.load('/data/ljo31/Lens/LensModels/twoband/J0913_212')
lp= result[0]
a2=0
...
xc,xo,yc,yo = xc-10,xo-10,yc-15,yo-15
...
S = myEmcee.Emcee(pars+[logP,likelihood],cov=optCov,nthreads=6,nwalkers=48)#ntemps=3)
S.sample_blobs(500)
outFile = '/data/ljo31/Lens/J0913/twoband_Kp_'+str(X)
f = open(outFile,'wb')
...
for jj in range(10):
    ...
    outFile = '/data/ljo31/Lens/J0913/twoband_Kp_blobs_'+str(X)
    f = open(outFile,'wb')
