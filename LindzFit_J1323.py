...
X = 40 - bm25_h
X = 41 - bm25_i
X = 46 - bm25_l. Source 2 has now got an effective radius more like 10 than 20. N = 1500, walkers = 100, threads = 6
X = 47 - as 46, only longer. N = 5000.
X = 49 - as 46, only reallyreallylong!
'''
...
guiFile = '/data/ljo31/Lens/J1323/bm25_l'
