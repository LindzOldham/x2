...
X=7 - doing the oversampling properly!!! The Gaussian class doesn't have OVRS coded into it.
'''
X = 7
...
S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nwalkers=50,nthreads=4,ntemps=3)
S.sample(500)
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=4,nwalkers=50,ntemps=3,initialPars=trace[-1])
    S.sample(500)
