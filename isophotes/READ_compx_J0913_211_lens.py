...
check=False # controls whether or not we plot things to screen
...
files = glob.glob('/data/ljo31/Lens/isophotes/compx_J0913_lens_211_*')
...
result = np.load('/data/ljo31/Lens/J0913/twoband_1')#/LensModels/new/J0913_212')#
name='J0913'
...
np.save('/data/ljo31/Lens/isophotes/J0913_211_lens_reff',[reff,reff*0.05,reff*0.05*scale])
