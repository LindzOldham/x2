...
X=27 - rerunning X=21, with lenson initially, and then turned off.
'''
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=10,nwalkers=72,ntemps=4,initialPars=trace[-1])
    S.sample(1000)
