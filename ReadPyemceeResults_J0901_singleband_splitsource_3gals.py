...
def NotPlicely(image,im,sigma):
    ...
    pl.colorbar()
    py.writeto('/data/ljo31/Lens/J0901/resid.fits',(image-im)/sigma,clobber=True)
    py.writeto('/data/ljo31/Lens/J0901/model.fits',im,clobber=True)
...
result = np.load('/data/ljo31/Lens/J0901/emcee36')
...
#re6,n6,pa6,q6,x6,y6 = dic['Galaxy 3 re'][a1,a2,a3], dic['Galaxy 3 n'][a1,a2,a3], dic['Galaxy 3 pa'][a1,a2,a3], dic['Galaxy 3 q'][a1,a2,a3], dic['Galaxy 3 x'][a1,a2,a3], dic['Galaxy 3 y'][a1,a2,a3]
...
print 'galaxy 3 ', '&', '%.2f'%x6, '&',  '%.2f'%y6, '&', '%.2f'%n6, '&', '%.2f'%re6, '&', '%.2f'%q6, '&','%.2f'%pa6,  r'\\'
...
print '\end{tabular} \n \caption{X = X. Shear = ', '%.4f'%shear, 'shear pa = ', '%.2f'%shearpa
