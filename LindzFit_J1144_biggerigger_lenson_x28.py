...
X=28 - FINAL RUN - rerunning X=24 (bestmodel) for a short while, to get uncertainties on lens params. Use emcee.
'''
...
import time
start=time.time()
S = myEmcee.Emcee(pars+[likelihood],cov=optCov,nwalkers=72,nthreads=10)
#S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=10,nwalkers=72,ntemps=4)
S.sample(4000)
print time.time()-start

outFile = '/data/ljo31/Lens/J1144/emcee_FINAL'+str(X)
f = open(outFile,'wb')
