...
result = np.load('/data/ljo31/Lens/J1446/emcee14')
...
for name in ['Galaxy 1','Galaxy 2']:
    ...
    if name == 'Galaxy 1':
        ...
        for key in 'x','y','xmax','pa','x0','y0':
            p[key] = dic[name+' '+key][a1,a2,a3]
        #for key in 'x','y':
        #    p[key] = gals[0].pars[key]
        gals.append(SBBModels.Disk(name,p))
...
re3,n3,pa3,x3,y3,xmax = dic['Galaxy 2 x0'][a1,a2,a3], dic['Galaxy 2 y0'][a1,a2,a3], dic['Galaxy 2 pa'][a1,a2,a3], dic['Galaxy 2 x'][a1,a2,a3], dic['Galaxy 2 y'][a1,a2,a3], dic['Galaxy 2 xmax'][a1,a2,a3]
...
print 'galaxy 2 ', '&', '%.2f'%x3, '&',  '%.2f'%y3, '&', '%.2f'%n3, '&', '%.2f'%re3, '&','%.2f'%xmax, '&','%.2f'%pa3,  r'\\'
