...
x,y = np.log10(re),logMvirL # units: 10^11 solar masses for both axes.
sxx, syy = dre/re, dlogMstarL # made up error for now - really need to go through chain
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/MLvirRe'
f = open(outFile,'wb')
cPickle.dump(S.result(),f,2)
f.close()
result = S.result()
result = np.load('/data/ljo31/Lens/Analysis/MLvirRe')
