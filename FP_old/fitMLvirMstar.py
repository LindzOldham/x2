...
x,y = logM-10.,logMvirL # units: 10^11 solar masses for both axes.
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/MLvirMstar'
f = open(outFile,'wb')
cPickle.dump(S.result(),f,2)
f.close()
result = S.result()
result = np.load('/data/ljo31/Lens/Analysis/MLvirMstar')
