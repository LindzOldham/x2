...
S.sample(6000)
outFile = '/data/ljo31b/EELs/FP/inference/FP_macs_logI'
f = open(outFile,'wb')
cPickle.dump(S.result(),f,2)
f.close()
result = S.result()'''
result = np.load('/data/ljo31b/EELs/FP/inference/FP_macs_logI')
...
pl.title('MACS')
pl.savefig('/data/ljo31b/EELs/esi/TeX/macsFPlogi.pdf')
pl.show()
