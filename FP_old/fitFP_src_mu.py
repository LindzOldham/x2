...
#xx,yy,zz,sxx,syy,szz = np.delete(xx,9),np.delete(yy,9),np.delete(zz,9),np.delete(sxx,9),np.delete(syy,9),np.delete(szz,9)
...
#S.sample(1000)
outFile = '/data/ljo31b/EELs/FP/inference/FP_src_mu_m2'
#f = open(outFile,'wb')
...
#pl.scatter(a*xo[9]+b*yo[9]+alpha,zo[9],color='Crimson')
