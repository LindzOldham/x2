...
x,y = logMvir[ii] -10.,fDM[ii] # units: 10^11 solar masses for both axes.
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/fDMMvir'
f = open(outFile,'wb')
cPickle.dump(S.result(),f,2)
f.close()
result = S.result()
result = np.load('/data/ljo31/Lens/Analysis/fDMMvir')
