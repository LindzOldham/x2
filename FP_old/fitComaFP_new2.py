...
for II in range(alp.size):
    ...
    pars.append(pymc.Uniform('sigma',0,1,0.1 )) 
    ...
    S.sample(600)
    outFile = '/data/ljo31b/EELs/FP/inference/FP_Comatest_4_'+str(II)
    f = open(outFile,'wb')
    cPickle.dump(S.result(),f,2)
    f.close()
    result = S.result()
    #result = np.load('/data/ljo31b/EELs/FP/inference/FP_Comatest')
    ...
    np.save('/data/ljo31b/EELs/FP/inference/FP_params_4',np.array(params))

params = np.array(params)
np.save('/data/ljo31b/EELs/FP/inference/FP_params_4',params)
...
params = np.load('/data/ljo31b/EELs/FP/inference/FP_params_4.npy')

pl.figure()
pl.scatter(params[:,0],params[:,3],color='SteelBlue',s=40)
...
pl.figure()
pl.scatter(params[:,1],params[:,4],color='SteelBlue',s=40)
...
pl.figure()
pl.scatter(params[:,2],params[:,5],color='SteelBlue',s=40)
