...
cov += [0.5]
# psf5
pars.append(pymc.Uniform('sigma 5',0.1,400,value= 20 )) 
cov += [1]
pars.append(pymc.Uniform('q 5',0,1,value=0.9))
cov += [0.5]
pars.append(pymc.Uniform('pa 5',-180,180,value= 90 ))
cov += [50]
pars.append(pymc.Uniform('amp 5',0,1,value=0.15))
cov += [0.5]
# psf6
pars.append(pymc.Uniform('sigma 6',0.1,400,value= 30 )) 
cov += [1]
...
jj=0
for jj in range(10):
    S = myEmcee.PTEmcee(pars+[likelihood],cov=optCov,nthreads=20,nwalkers=60,ntemps=3,initialPars=trace[a1])
    S.sample(500)
