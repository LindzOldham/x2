...
# Grab the SED models
files = glob.glob('/data/mauger/STELLARPOP/salpeter_Z*dat')
...
for key in szs.keys():
    ...
    outname = '/data/ljo31b/EELs/spsmodels/wide/'+name+'_source_salpBC03.model'
    finished = glob.glob('/data/ljo31b/EELs/spsmodels/wide/*_source_salpBC03.model')
...
for key in lzs.keys():
    ...
    outname = '/data/ljo31b/EELs/spsmodels/wide/'+name+'_lens_salpBC03.model'
    finished = glob.glob('/data/ljo31b/EELs/spsmodels/wide/*_lens_salpBC03.model')
    if outname in finished:
        continue
    f = open(outname,'wb')
...
for key in szs.keys():
    ...
    outname = '/data/ljo31b/EELs/spsmodels/wide/'+name+'_source_212_salpBC03.model'
    finished = glob.glob('/data/ljo31b/EELs/spsmodels/wide/*_source_212_salpBC03.model')
    if outname in finished:
        continue
    f = open(outname,'wb')
