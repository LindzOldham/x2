...
n=0
for name in names:
    result = np.load('/data/ljo31b/EELs/inference/new/huge/result_212_CHECK_'+name)
...
np.save('/data/ljo31b/EELs/inference/new/huge/chabrier_masses_212.npy',newmasses)
