...
np.save('/data/ljo31/Lens/LensParams/ReMass_1src_new',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/sizemass_1src_inferredage_new'
f = open(outFile,'wb')
...
np.save('/data/ljo31/Lens/Analysis/sizemass_1src_fit_new',np.column_stack((xfit,yfit,lo,up)))
