...
table = py.open('/data/ljo31/Lens/LensParams/Phot_2src_huge_new_new.fits')[1].data
...
pars.append(pymc.Uniform('beta',0,10 ))
pars.append(pymc.Uniform('sigma',0,0.9))
pars.append(pymc.Uniform('tau',0.001,2))
pars.append(pymc.Uniform('mu',8,14))
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/huge/check1'
f = open(outFile,'wb')
