...
sigma = pymc.Uniform('sigma',0,10.)#,value=3.)
...
pl.subplot(311)
pl.hist(dic['alpha'][6000:].ravel(),30)
pl.title('alpha')
pl.subplot(312)
pl.hist(dic['beta'][6000:].ravel(),30)
pl.title('beta')
pl.subplot(313)
pl.hist(dic['sigma'][6000:].ravel(),30)
pl.title('sigma')
...
#pl.savefig('/data/ljo31/public_html/Lens/phys_models/intrinsic_v_observed.png')
pl.show()
