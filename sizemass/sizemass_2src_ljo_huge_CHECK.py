...
np.save('/data/ljo31/Lens/LensParams/ReMass_2src_huge_ljo_huge_NEWFORFPNEW',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
...
#S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/huge/sizemass_2src_ljo_NEWFORFPNEW'
#f = open(outFile,'wb')
