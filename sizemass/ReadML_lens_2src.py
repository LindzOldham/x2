...
vi,vk=v-i,v-k
np.save('/data/ljo31/Lens/LensParams/colours_lens_2src',[vi,vk,dvi,dvk,v,i,k,Re,dRe])
...
pars = np.zeros(12)
result = np.load('/data/ljo31/Lens/Analysis/2src_VKIage_lensgals_wideprior_new')
...
np.save('/data/ljo31/Lens/LensParams/LensgalInferredAges_2src_new',data)
