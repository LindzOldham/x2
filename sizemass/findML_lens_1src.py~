...
# try using the 2-src model for J1125
#vi[3],vk[3] = 1.15,2.77# -1 src are 1.13 and 2.73 so not much different but you never know...Otherwise, could try refitting K band and inferring galaxy model as well? This is even worse...
...
outFile = '/data/ljo31/Lens/Analysis/1src_VKIage_lensgals_wideprior_j1125'
f = open(outFile,'wb')
