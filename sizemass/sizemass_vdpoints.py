...
logRel,logMl,dlogRel,dlogMl,rhol = np.load('/data/ljo31/Lens/LensParams/ReMass_lensgals_1src_huge_ljo.npy').T
pl.scatter(logMl,logRel,color='Crimson',s=30,label='EELs lenses')
plot_ellipses(logMl,logRel,dlogMl,dlogRel,rhol,'Crimson')
...
pl.legend(loc='upper left',ncol=2,fontsize=15,scatterpoints=1)
