...
x,y = logRe,np.log10(srcage)
sxx, syy = dlogRe, dsrcage/srcage/np.log(10.)
...
pars.append(pymc.Uniform('sigma',0,2.0,value=0.01))
pars.append(pymc.Uniform('tau',0.001,10,value=0.1))
pars.append(pymc.Uniform('mu',0,2,value=0.5))
...
S.sample(3000)
outFile = '/data/ljo31/Lens/Analysis/huge/sizeage'
f = open(outFile,'wb')
...
pl.xlabel(r'$\log(R_e/kpc)$')
pl.ylabel(r'$\log(T_{src})$')
