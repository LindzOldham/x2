...
table = py.open('/data/ljo31/Lens/LensParams/Phot_2src_lensgals_huge_new.fits')[1].data
...
np.save('/data/ljo31/Lens/LensParams/ReMass_lensgals_2src_huge_ljo',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/huge/sizemass_2srclensgals_ljo'
f = open(outFile,'wb')
