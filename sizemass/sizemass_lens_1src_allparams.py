...
np.save('/data/ljo31/Lens/LensParams/ReMass_lensgals_1src_allparams',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
...
S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/sizemass_1src_inferredage_lensgals_allparams'
f = open(outFile,'wb')
