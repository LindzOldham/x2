...
tablek = np.load('/data/ljo31/Lens/LensParams/KeckPhot_1src_new_dict.npy')[()]
tableklens = np.load('/data/ljo31/Lens/LensParams/KeckPhot_lensgals_1src_new_dict.npy')[()]
...
dic = dict(dic)
np.save('/data/ljo31/Lens/LensParams/VIK_phot_211_dict_new',dic)
