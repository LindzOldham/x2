...
table = py.open('/data/ljo31/Lens/LensParams/Phot_1src_lensgals_huge_new.fits')[1].data
...
np.save('/data/ljo31/Lens/LensParams/ReMass_lensgals_1src_huge_ljo',np.column_stack((logRe,logM,dlogRe,dlogM,rho)))
...
#S.sample(4000)
outFile = '/data/ljo31/Lens/Analysis/huge/sizemass_1srclensgals_ljo'
#f = open(outFile,'wb')
...
pl.scatter(x,y,color='Crimson',label='EELs lenses')
#pl.errorbar(x,y,xerr=sxx,yerr=syy,fmt='o',color='SteelBlue')
...
#pl.plot(xfit,vdWfit2,'k-.',label='van der Wel+14, z=0.25')
#pl.plot(xfit,shenfit,'k-',lw=0.5,label='Shen+03, z= 0')
pl.legend(loc='upper left',fontsize=15,ncol=2,scatterpoints=1)
