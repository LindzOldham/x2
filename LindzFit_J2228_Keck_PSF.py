...
#X=0
X=1 # 5 components instead of four.
X='final'
print X
...
cov +=[5,0.5,50,0.5]
# psf5
pars.append(pymc.Uniform('sigma 5',0.1,100,value= 30 )) 
...
psfObj5 = SBObjects.Gauss('psf 5',{'x':0,'y':0,'sigma':pars[18],'q':pars[19],'pa':pars[20],'amp':pars[21]})
psfObjs = [psfObj1,psfObj2,psfObj3,psfObj4,psfObj5]
...
S.sample(500)
outFile = '/data/ljo31/Lens/J2228/KeckPSF_'+str(X)
f = open(outFile,'wb')
