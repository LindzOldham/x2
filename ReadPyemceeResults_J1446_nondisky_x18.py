...
result = np.load('/data/ljo31/Lens/J1446/emcee19')
...
for name in ['Galaxy 1','Galaxy 2']:
    ...
    if name == 'Galaxy 1':
        ...
        gals.append(SBBModels.ExpDisk(name,p))
...
re3,n3,pa3,x3,y3,q3 = dic['Galaxy 2 xmax'][a1,a2,a3], dic['Galaxy 2 x0'][a1,a2,a3], dic['Galaxy 2 pa'][a1,a2,a3], dic['Galaxy 2 x'][a1,a2,a3], dic['Galaxy 2 y'][a1,a2,a3],dic['Galaxy 2 y0'][a1,a2,a3] 
