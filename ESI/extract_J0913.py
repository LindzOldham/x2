...
def extract(pref,nums,wid=1.,wht=False):
    ...
    np.save('/data/ljo31b/EELs/esi/kinematics/J0913_apertures',apsize)
...
ow,s,v = extract('/data/ljo31b/EELs/esi/J0913/EEL_J0913+4237',[39,40,41],wid=1)
...
pl.suptitle('J0913')
#pl.savefig('/data/ljo31/public_html/Lens/esi/spectra/J0913.pdf')
#py.writeto('/data/ljo31b/EELs/esi/kinematics/J0913_spec.fits',s,clobber=True)
#py.writeto('/data/ljo31b/EELs/esi/kinematics/J0913_var.fits',v,clobber=True)
#py.writeto('/data/ljo31b/EELs/esi/kinematics/J0913_wl.fits',ow,clobber=True)
