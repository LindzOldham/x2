...
def extract(pref,nums,wid=1.,wht=False):
    ...
    np.save('/data/ljo31b/EELs/esi/kinematics/J0901_apertures',apsize)
...
ow,s,v = extract('/data/ljo31b/EELs/esi/J0901/EEL_J0901+2027',[36,37,38],wid=1)
...
pl.suptitle('J0901')
#pl.savefig('/data/ljo31/public_html/Lens/esi/spectra/J0901.pdf')
#py.writeto('/data/ljo31b/EELs/esi/kinematics/J0901_spec.fits',s,clobber=True)
#py.writeto('/data/ljo31b/EELs/esi/kinematics/J0901_var.fits',v,clobber=True)
#py.writeto('/data/ljo31b/EELs/esi/kinematics/J0901_wl.fits',ow,clobber=True)
