...
#pylab.figure()
ow,s,v = extract('/data/ljo31b/EELs/esi/J0837/EEL_J0837+0801',[33,34,35],loc=[57,92,25],wid=3)
...
pylab.savefig('/data/ljo31/public_html/Lens/esi/spectra/wide/J0837.pdf')

pyfits.writeto('/data/ljo31b/EELs/esi/kinematics/wide/J0837_spec.fits',s)
pyfits.writeto('/data/ljo31b/EELs/esi/kinematics/wide/J0837_var.fits',v)
pyfits.writeto('/data/ljo31b/EELs/esi/kinematics/wide/J0837_wl.fits',ow)
pylab.show()

'''ow = ow[:-33][5::10]
s = numpy.sort(s[:-33].reshape((2*1330,10)),1)[:,3:-3].sum(1)
v = numpy.sort(s[:-33].reshape((2*1330,10)),1)[:,3:-3].sum(1)
pylab.figure()
pylab.plot(10**ow,s,'k')
pylab.plot(10**ow,v,'r')
pl.xlim(4000.,9000.)
