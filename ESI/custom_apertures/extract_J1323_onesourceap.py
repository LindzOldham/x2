...
def extract(pref,nums,wid=1.,wht=False,centroid=None,rein=None,lens=True,source=False,regal=None):
    ...
    np.save('/data/ljo31b/EELs/esi/kinematics/J1323_wide_apertures',apsize)
...
#ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1323+3946',[36,37,38],wid=1.5,centroid=centroids[name],rein=reins[name],lens=False,source=True,regal=regal)

ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1323+3946',[36,37,38],wid=0.3,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
