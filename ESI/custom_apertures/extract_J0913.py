...
def extract(pref,nums,wid=1.,wht=False,regal=5.,centroid=None,rein=None,lens=True,source=False):
    ...
    pl.suptitle(name)
    if lens:
        pl.savefig('/data/ljo31/public_html/Lens/esi/apertures/'+name+'_'+str(wid)+'_lens.png')
    elif source:
        pl.savefig('/data/ljo31/public_html/Lens/esi/apertures/'+name+'_'+str(wid)+'_source.png')
    pl.show()
    if lens:
        ...
        py.writeto('/data/ljo31b/EELs/esi/kinematics/apertures/'+name+'_ap_'+'%.2f'%wid+'_spec_source.fits',s,clobber=True)
        py.writeto('/data/ljo31b/EELs/esi/kinematics/apertures/'+name+'_ap_'+'%.2f'%wid+'_var_source.fits',v,clobber=True)
        py.writeto('/data/ljo31b/EELs/esi/kinematics/apertures/'+name+'_ap_'+'%.2f'%wid+'_wl_source.fits',ow,clobber=True)
...
ow,s,v = extract('/data/ljo31b/EELs/esi/J0913/EEL_J0913+4237',[39,40,41],wid=1.5,regal=regal,centroid=centroids[name],rein=reins[name],lens=False,source=True)
ow,s,v = extract('/data/ljo31b/EELs/esi/J0913/EEL_J0913+4237',[39,40,41],wid=1.0,regal=regal,centroid=centroids[name],rein=reins[name],lens=True,source=False)
