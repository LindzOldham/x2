...
#pylab.figure()
ow,s,v = extract('/data/ljo31b/EELs/esi/J0837/EEL_J0837+0801',[33,34,35],regal,loc=[57,92,25],wid=1.5,centroid=centroids[name],rein=reins[name],lens=False,source=True)

ow,s,v = extract('/data/ljo31b/EELs/esi/J0837/EEL_J0837+0801',[33,34,35],regal,loc=[57,92,25],wid=1.,centroid=centroids[name],rein=reins[name],lens=True,source=False)
