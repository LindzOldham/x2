...
def extract(pref,nums,wid=1.,wht=False,centroid=None,lens=True,source=False):
    ...
    for numIndx in range(len(nums)):
        ...
        for order in range(1,11):
            ...
            source2cent = lenscent+0.25/arcsecperpix[order-1]
...
ow,s,v = extract('/data/ljo31b/EELs/esi/J0913/EEL_J0913+4237',[39,40,41],wid=0.31,centroid=centroids[name],lens=False,source=True)

ow,s,v = extract('/data/ljo31b/EELs/esi/J0913/EEL_J0913+4237',[39,40,41],wid=1.0,centroid=centroids[name],lens=True,source=False)
