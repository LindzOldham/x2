...
name = 'J1446'
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1446+3856',[39,40,41],wid=0.31,centroid=centroids[name],rein=reins[name],lens=False,source=True,regal=regal)
