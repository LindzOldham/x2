...
#ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1619+2024',[51,52,53],wid=1.5,centroid=centroids[name],rein=reins[name],lens=False,source=True,regal=regal)
