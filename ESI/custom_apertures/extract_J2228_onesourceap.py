...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J2228-0018',[54,55],wid=1.5,centroid=centroids[name],rein=reins[name],lens=False,source=True,regal=regal)
