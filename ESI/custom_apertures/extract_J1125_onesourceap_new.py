...
def extract(pref,nums,wid=1.,wht=False,regal=5.,centroid=None,rein=None,lens=True,source=False):
    ...
    for numIndx in range(len(nums)):
        ...
        for order in range(1,11):
            ...
            source1cent = lenscent+0.6/arcsecperpix[order-1]
            source2cent = lenscent-1.00/arcsecperpix[order-1]
...
ow,s,v = extract('/data/ljo31b/EELs/esi/J1125/EEL_J1125+3058',[46,46,47],wid=0.31,regal=regal,centroid=centroids[name],rein=reins[name],lens=False,source=True)
