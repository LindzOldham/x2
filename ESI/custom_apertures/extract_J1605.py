...
name = 'J1605'
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1605+3811',[45,46,47],wid=wid)
...
pl.suptitle(name)
py.writeto('/data/ljo31b/EELs/esi/kinematics/apertures/'+name+'_ap_'+'%.2f'%wid+'_spec.fits',s,clobber=True)
py.writeto('/data/ljo31b/EELs/esi/kinematics/apertures/'+name+'_ap_'+'%.2f'%wid+'_var.fits',v,clobber=True)
py.writeto('/data/ljo31b/EELs/esi/kinematics/apertures/'+name+'_ap_'+'%.2f'%wid+'_wl.fits',ow,clobber=True)
pl.show()
