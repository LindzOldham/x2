...
def extract(pref,nums,wid=1.,wht=False,regal=5.,centroid=None,rein=None,lens=True,source=False):
    ...
    for numIndx in range(len(nums)):
        ...
        for order in range(1,11):
            ...
            source1cent = lenscent-0.25/arcsecperpix[order-1]
            source2cent = lenscent+0.95/arcsecperpix[order-1]
...
ow,s,v = extract('/data/ljo31b/EELs/esi/'+name+'/EEL_J1144+1540',[48,49,50],wid=0.31,regal=regal,centroid=centroids[name],rein=reins[name],lens=False,source=True)
