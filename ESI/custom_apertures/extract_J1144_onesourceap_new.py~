...
ow,s,v = extract('/data/ljo31b/EELs/esi/'+name+'/EEL_J1144+1540',[48,49,50],wid=1.5,regal=regal,centroid=centroids[name],rein=reins[name],lens=False,source=True)
ow,s,v = extract('/data/ljo31b/EELs/esi/'+name+'/EEL_J1144+1540',[48,49,50],wid=1.0,regal=regal,centroid=centroids[name],rein=reins[name],lens=True,source=False)
