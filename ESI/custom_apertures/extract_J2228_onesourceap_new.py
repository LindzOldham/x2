...
def extract(pref,nums,wid=1.,wht=False,centroid=None,rein=None,lens=True,source=False,regal=None):
    ...
    for numIndx in range(len(nums)):
        ...
        for order in range(1,11):
            ...
            lenscent = fit[2] + centroid*0.05/arcsecperpix[order-1] + 0.6/arcsecperpix[order-1]
            ...
            sourceap = np.where(((abs(x-source1cent)<wid/arcsecperpix[order-1])),1.,0.)
...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J2228-0018',[54,55],wid=0.3,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)

ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J2228-0018',[54,55],wid=0.2,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)


pl.show()

#ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J2228-0018',[54,55],wid=1.0,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
