...
def extract(pref,nums,wid=1.,wht=False,centroid=None,rein=None,lens=True,source=False,regal=None):
    ...
    for numIndx in range(len(nums)):
        ...
        for order in range(1,11):
            ...
            #source1cent = lenscent-rein*0.05/arcsecperpix[order-1]
            #source2cent = lenscent+rein*0.05/arcsecperpix[order-1]
            source1cent = lenscent-0.4/arcsecperpix[order-1]
            source2cent = lenscent+1.0/arcsecperpix[order-1]
    ...
    if lens:
        ...
        pl.savefig('/data/ljo31/public_html/Lens/esi/apertures/final/'+name+'_'+str(wid)+'_sourceb.png')
    pl.show()
    if lens:
...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/jul2016/run/EEL_J1605+3811',[49,50],wid=0.31,centroid=centroids[name],rein=reins[name],lens=False,source=True,regal=regal)

#ow,s,v = extract('/data/ljo31b/EELs/esi/raw/jul2016/run/EEL_J1605+3811',[49,50],wid=1.0,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
