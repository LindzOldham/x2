...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1605+3811',[45,46,47],wid=1.5,centroid=centroids[name],rein=reins[name],lens=False,source=True,regal=regal)

ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1605+3811',[45,46,47],wid=1.0,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
