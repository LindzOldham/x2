...
name = 'J1446'
#ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1446+3856',[39,40,41],wid=1.5,centroid=centroids[name],rein=reins[name],lens=False,source=True,regal=regal)

ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1446+3856',[39,40,41],wid=0.3,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
