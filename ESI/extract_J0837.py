...
#pylab.figure()
ow,s,v = extract('/data/ljo31b/EELs/esi/J0837/EEL_J0837+0801',[33,34,35],loc=[57,92,25],wid=1)
...
pylab.savefig('/data/ljo31/public_html/Lens/esi/spectra/J0837.pdf')

#pyfits.writeto('/data/ljo31b/EELs/esi/kinematics/J0837_spec.fits',s)
#pyfits.writeto('/data/ljo31b/EELs/esi/kinematics/J0837_var.fits',v)
#pyfits.writeto('/data/ljo31b/EELs/esi/kinematics/J0837_wl.fits',ow)
