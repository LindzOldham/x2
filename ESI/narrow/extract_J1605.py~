...
def extract(pref,nums,wid=1.,wht=False):
    ...
    np.save('/data/ljo31b/EELs/esi/kinematics/J1605_wide_apertures',apsize)
...
name = 'J1605'
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1605+3811',[45,46,47],wid=0.75)
...
pl.suptitle(name)
pl.savefig('/data/ljo31/public_html/Lens/esi/spectra/narrow/'+name+'.pdf')
