...
name = 'J1218'
ow,s,v = extract('/data/ljo31b/EELs/esi/'+name+'/EEL_J1218+5648',[51,52,53],wid=0.75)
...
pl.suptitle(name)
py.writeto('/data/ljo31b/EELs/esi/kinematics/narrow/'+name+'_spec.fits',s,clobber=True)
py.writeto('/data/ljo31b/EELs/esi/kinematics/narrow/'+name+'_var.fits',v,clobber=True)
py.writeto('/data/ljo31b/EELs/esi/kinematics/narrow/'+name+'_wl.fits',ow,clobber=True)
