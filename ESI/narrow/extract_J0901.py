...
ow,s,v = extract('/data/ljo31b/EELs/esi/J0901/EEL_J0901+2027',[36,37,38],wid=0.75)
...
pl.suptitle('J0901')
py.writeto('/data/ljo31b/EELs/esi/kinematics/narrow/J0901_spec.fits',s,clobber=True)
py.writeto('/data/ljo31b/EELs/esi/kinematics/narrow/J0901_var.fits',v,clobber=True)
py.writeto('/data/ljo31b/EELs/esi/kinematics/narrow/J0901_wl.fits',ow,clobber=True)
