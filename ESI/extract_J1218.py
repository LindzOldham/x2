...
def extract(pref,nums,wid=1.,wht=False):
    ...
    np.save('/data/ljo31b/EELs/esi/kinematics/J1218_apertures',apsize)
...
name = 'J1218'
ow,s,v = extract('/data/ljo31b/EELs/esi/'+name+'/EEL_J1218+5648',[51,52,53],wid=1)
...
pl.suptitle(name)
#pl.savefig('/data/ljo31/public_html/Lens/esi/spectra/'+name+'.pdf')
#py.writeto('/data/ljo31b/EELs/esi/kinematics/'+name+'_spec.fits',s,clobber=True)
#py.writeto('/data/ljo31b/EELs/esi/kinematics/'+name+'_var.fits',v,clobber=True)
#py.writeto('/data/ljo31b/EELs/esi/kinematics/'+name+'_wl.fits',ow,clobber=True)
