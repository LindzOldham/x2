...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1446+3856',[39,40,41],wid=0.5,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
