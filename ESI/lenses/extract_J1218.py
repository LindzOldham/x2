...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/jan2015/run/EEL_J1218+5648',[51,52,53],wid=0.5,regal=regal,centroid=centroids[name],rein=reins[name],lens=True,source=False)
pl.show()
