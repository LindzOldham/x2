...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1606+2235',[48,49,50],wid=0.5,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
pl.show()
