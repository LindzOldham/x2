...
ow,s,v = extract('/data/ljo31b/EELs/esi/raw/may2014/run/EEL_J1619+2024',[51,52,53],wid=0.5,centroid=centroids[name],rein=reins[name],lens=True,source=False,regal=regal)
