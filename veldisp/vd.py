...
name = '20'
print name
result = run(0.4256,0.6411,fit=True,read=False,File = 'J0837_'+name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=6000,bias=1e8)#,restmask=np.array([[3900,3990]]))
result = run(0.4246,0.6411,fit=False,read=True,File = 'J0837_'+name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=6000,bias=1e8)#,restmask=np.array([[3900,3990]]))
