...
name = 'J0901_stitch_1'
print name
result = run(0.311,0.586,fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4800,bias=1e8,srclim=5800.)
result = run(0.311,0.586,fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4800,bias=1e8,srclim=5800.)
pl.title(name[:5])
pl.show()
'''
...
'''name = 'J0913_stitch_0'
print name
result = run(0.395,0.539,fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5150,bias=1e8,srclim=5700.)
result = run(0.395,0.539,fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5150,bias=1e8,srclim=5700.)
pl.title(name[:5])
pl.show()'''
...
result = run(0.442,0.689,fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5300,bias=1e8,srclim=6200.)
result = run(0.442,0.689,fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5300,bias=1e8,srclim=6200.)
pl.title(name[:5])
pl.show()
'''
'''
...
result = run(0.372,0.706,fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5050,bias=1e8,srclim=6300.)
result = run(0.372,0.706,fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5050,bias=1e8,srclim=6300.)
pl.title(name[:5])
pl.show()
'''
name = 'J1218_stitch_0'
...
#result = run(0.3182,0.6009,fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4900.,bias=1e8,srclim=5900.)
result = run(0.3182,0.6009,fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4900.,bias=1e8,srclim=5900.)
pl.title(name[:5])
pl.show()
