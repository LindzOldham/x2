...
for name in names:
    ...
    print name, '& $',
    try:
        result = np.load('/data/ljo31b/EELs/esi/kinematics/inference/vdfit/'+name+'_1.5_source_esi_bc03_vdfit')
    except:
...
vl,sl,vs,ss = MM.T
np.save('/data/ljo31b/EELs/esi/kinematics/inference/results_1.50_source_bc03_vdfit',[LL,MM,UU])
np.save('/data/ljo31/Lens/LensParams/SourceRedshiftsUpdated_1.50_source_bc03_vdfit',dict(sznew))
np.save('/data/ljo31/Lens/LensParams/LensRedshiftsUpdated_1.50_source_bc03_vdfit',dict(lznew))'''
