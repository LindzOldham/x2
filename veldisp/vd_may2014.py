...
if name == 'J1248':
    ...
    result = run(lz[name],sz[name],fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5750.,bias=1e8)
    result = run(lz[name],sz[name],fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5750.,bias=1e8)
    pl.title(name[:5])
    pl.show()
    ...
    sigsci = resolutions[name[:5]] * light
    result = run(lz[name],sz[name],fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=6000.,bias=1e8)
    result = run(lz[name],sz[name],fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=6000.,bias=1e8)
    pl.title(name[:5])
    pl.show()

elif name == 'J1446':
    sigsci = resolutions[name[:5]] * light
    result = run(lz[name],sz[name],fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5800.,bias=1e8)
    result = run(lz[name],sz[name],fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5900.,bias=1e8)
    pl.title(name[:5])
    pl.show()

elif name == 'J1605':
    sigsci = resolutions[name[:5]] * light
    result = run(lz[name],sz[name],fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5700.,bias=1e8)
    result = run(lz[name],sz[name],fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5700.,bias=1e8)
    pl.title(name[:5])
    pl.show()

elif name == 'J1606':
    sigsci = resolutions[name[:5]] * light
    result = run(lz[name],sz[name],fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=6100.,bias=1e9)
    result = run(lz[name],sz[name],fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=6100.,bias=1e9)
    pl.title(name[:5])
    pl.show()

elif name == 'J1619':
    sigsci = resolutions[name[:5]] * light
    result = run(lz[name],sz[name],fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5900.,bias=1e9)
    result = run(lz[name],sz[name],fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5900.,bias=1e9)
    pl.title(name[:5])
    pl.show()
    ...
    name = name+'_tests'
    sigsci = resolutions[name[:5]] * light
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5300.,bias=1e8)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = name,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5300.,bias=1e8)
    pl.title(name[:5])
    pl.show()
