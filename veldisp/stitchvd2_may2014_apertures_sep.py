...
if name=='J1248':
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4500.,bias=1e8,srclim=5750.,lenslim=4900.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4500.,bias=1e8,srclim=5750.,lenslim=4900.,wid=wid,typ=typ)
    pl.title(name[:5])
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=5500.,lenslim=4900.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=5500.,lenslim=4900.,wid=wid,typ=typ)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e10,srclim=6000.,lenslim=5200.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e10,srclim=6000.,lenslim=5200.,wid=wid,typ=typ)
    pl.title(name+' '+typ+' '+str(wid))
    pl.xlim([4750,9000])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    #pl.show()
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e9,srclim=5800.,lenslim=4850.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e9,srclim=5800.,lenslim=4850.,wid=wid,typ=typ)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=5700.,lenslim=4850.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=5700.,lenslim=4850.,wid=wid,typ=typ)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=6100.,lenslim=5100.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=6100.,lenslim=5100.,wid=wid,typ=typ)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=5900.,lenslim=5000.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4750.,bias=1e8,srclim=5900.,lenslim=5000.,wid=wid,typ=typ)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    result = run(lz[name[:5]],sz[name[:5]],fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4550.,bias=1e8,srclim=5300.,lenslim=4600.,wid=wid,typ=typ)
    result = run(lz[name[:5]],sz[name[:5]],fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4550.,bias=1e8,srclim=5300.,lenslim=4600.,wid=wid,typ=typ)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
