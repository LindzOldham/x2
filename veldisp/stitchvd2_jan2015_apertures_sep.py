...
if name=='J0837':
    ...
    result = run(0.4256,0.6411,fit=True,read=False,File = filename,mask=np.array([[7580,7700],[5295,5325],[5570,5585],[6860,6900]]),nfit=12,bg='polynomial',lim=5000,bias=1e10,srclim=6000.,lenslim=5500.,typ=typ,wid=wid)
