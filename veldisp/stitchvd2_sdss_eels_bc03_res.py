...
if name == 'J0837':
    filename='bc03_sdss_2_'+name
    #result = run(0.4246,0.6411,fit=True,read=False,File = filename,mask=np.array([[5570,5585],[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4900,bias=1e3,srclim=5300.,lenslim=5000.,name=name,make=False)
    result = run(0.4246,0.6411,fit=False,read=True,File = filename,mask=np.array([[5570,5585],[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4900,bias=1e3,srclim=5300.,lenslim=5000.,name=name)
    pl.suptitle(name)
    ...
    result = run(0.311,0.586,fit=True,read=False,File = filename,mask=np.array([[5570,5585],[7580,7700],[6860,6900]]),nfit=10,bg='polynomial',lim=4900,bias=1e2,srclim=5150.,lenslim=4950.,name=name,make=True)
    result = run(0.311,0.586,fit=False,read=True,File = filename,mask=np.array([[5570,5585],[7580,7700],[6860,6900]]),nfit=10,bg='polynomial',lim=4900,bias=1e2,srclim=5150.,lenslim=4950.,name=name)
    ...
    print name
    result = run(0.395,0.539,fit=True,read=False,File = filename,mask=np.array([[5570,5585],[7580,7700],[6860,6900]]),nfit=12,bg='polynomial',lim=4500,bias=1e3,srclim=5700.,lenslim=5150.,name=name,make=True)
