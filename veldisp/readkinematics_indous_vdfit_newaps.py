...
for name in names:
    ...
    if name == 'J1605':
        ...
        result = np.load('/data/ljo31b/EELs/esi/kinematics/inference/vdfit/'+name+'_0.3_lens_esi_indous_vdfit')
    elif name == 'J1619':
        result = np.load('/data/ljo31b/EELs/esi/kinematics/inference/vdfit/'+name+'_0.30_lens_esi_indous_vdfit')
    elif name == 'J2228':
        result = np.load('/data/ljo31b/EELs/esi/kinematics/inference/vdfit/jul2016_'+name+'_1.10_source_esi_indous_vdfit')
    else:
        result = np.load('/data/ljo31b/EELs/esi/kinematics/inference/vdfit/'+name+'_0.31_source_esi_indous_vdfit')
...
vl,sl,vs,ss = MM.T
np.save('/data/ljo31b/EELs/esi/kinematics/inference/results_0.30_source_indous_vdfit_jul2016_J2228',[LL,MM,UU])
np.save('/data/ljo31/Lens/LensParams/SourceRedshiftsUpdated_0.30_source_indous_vdfit_jul2016_J2228',dict(sznew))
np.save('/data/ljo31/Lens/LensParams/LensRedshiftsUpdated_0.30_source_indous_vdfit_jul2016_J2228',dict(lznew))
