...
def finddispersion(scispec,varspec,t1,t2,outwave,zl,zs,nfit=12,outfile=None,mask=None,bias=1e8,lim=4000.,bg='polynomial',restmask=None,srclim=6000.,maxlim=8000.,nthr=8):
