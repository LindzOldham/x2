...
spec1 = py.open('/data/ljo31b/EELs/esi/testcode/spec-1653-53534-0550.fits')[1].data
spec2 = py.open('/data/ljo31b/EELs/esi/testcode/spec-2157-54242-0324.fits')[1].data

z1,z2 =0.311078,0.111974
veldisp1, veldisp2 = 272.33, 229.57
...
np.save('/data/ljo31b/EELs/esi/testcode/summedspec_neu_neu',[wl2,flux,var])
