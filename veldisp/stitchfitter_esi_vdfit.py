...
def finddispersion(scispec,varspec,t1,t2,outwave,zl,zs,nfit=12,outfile=None,mask=None,bias=100,lim=4000.,bg='polynomial',restmask=None,srclim=6000.,maxlim=8000.,nthr=8):
    ...
    S = myEmcee.Emcee(pars+[logp],cov=cov/2.,nthreads=nthr,nwalkers=50)
    S.sample(500)
    outFile = '/data/ljo31b/EELs/esi/kinematics/inference/vdfit/'+outfile
    f = open(outFile,'wb')
...
def readresults(scispec,varspec,t1,t2,outwave,zl,zs,nfit=12,infile=None,mask=None,bias=1e8,lim=5000.,bg='polynomial',restmask=None,srclim=6000.,maxlim=8000.):
   ...
   # Create the polynomial fit components
    ...
    result = np.load('/data/ljo31b/EELs/esi/kinematics/inference/vdfit/'+infile)
