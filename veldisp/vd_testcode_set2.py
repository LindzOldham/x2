...
def run(zl,zs,fit=True,read=False,File=None,mask=None,lim=6000.,nfit=6.,bg='polynomial',bias=1e8):
    # Load in spectrum
    sciwave,scispec,varspec = np.load('/data/ljo31b/EELs/esi/testcode/summedspec_set2.npy')
    #varspec = varspec**-2.
...
name='testcodehitrueres3_N'#_hires'
...
pl.show()
'''
result = np.load('/data/ljo31b/EELs/esi/kinematics/trials/testcodehitrueres3_N')
