...
print typ
if name=='J0837':
    filename = name+'_'+wid+'_zv'
    sigsci = resolutions[name] * light * np.log(10.)
    print sigsci
    filename = name+'_'+wid+'_'+typ
    result = run(0.4256,0.6411,fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5000,bias=1e8,srclim=6000.,lenslim=5500.,typ=typ,wid=wid)
    result = run(0.4246,0.6411,fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5000,bias=1e8,srclim=6000.,lenslim=5500.,typ=typ,wid=wid)
    pl.title(name[:5])
    ...
    print sigsci
    filename = name+'_'+wid+'_'+typ
    #result = run(0.311,0.586,fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4500,bias=1e8,srclim=5800.,lenslim=5000.,typ=typ,wid=wid)
    result = run(0.311,0.586,fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4500,bias=1e8,srclim=5800.,lenslim=5000.,typ=typ,wid=wid)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')

elif name == 'J0913':
    filename = name+'_'+wid+'_full'
    sigsci = resolutions[name] * light* np.log(10.)
    print sigsci
    filename = name+'_'+wid+'_'+typ
    #result = run(0.395,0.539,fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4500,bias=1e8,srclim=5700.,lenslim=5150.,typ=typ,wid=wid)
    result = run(0.395,0.539,fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4500,bias=1e8,srclim=5700.,lenslim=5150.,typ=typ,wid=wid)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    print sigsci
    filename = name+'_'+wid+'_'+typ
    #result = run(0.442,0.689,fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4500.,bias=1e8,srclim=6200.,lenslim=5300.,typ=typ,wid=wid)
    result = run(0.442,0.689,fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4500.,bias=1e8,srclim=6200.,lenslim=5300.,typ=typ,wid=wid)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    print sigsci
    filename = name+'_'+wid+'_'+typ
    #result = run(0.372,0.706,fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5000.,bias=1e8,srclim=6300.,lenslim=5050.,typ=typ,wid=wid)
    result = run(0.372,0.706,fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=5000.,bias=1e8,srclim=6300.,lenslim=5050.,typ=typ,wid=wid)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
    ...
    print sigsci
    filename = name+'_'+wid+'_'+typ
    result = run(0.3182,0.6009,fit=True,read=False,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4750.,bias=1e8,srclim=5900.,lenslim=4900.,typ=typ,wid=wid)
    #result = run(0.3182,0.6009,fit=False,read=True,File = filename,mask=np.array([[7580,7700],[6860,6900]]),nfit=6,bg='polynomial',lim=4750.,bias=1e8,srclim=5900.,lenslim=4900.,typ=typ,wid=wid)
    pl.title(name[:5])
    pl.savefig('/data/ljo31b/EELs/esi/kinematics/plots/apertures/final/'+filename+'.pdf')
