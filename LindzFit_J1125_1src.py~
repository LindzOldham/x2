...
X = 33 - gui_29b_D - put 29b back into the terminal and imposed MASSIVE improvements (I think, anyway!) SPLITSOURCE
X = 34 - gui_29b_C1 SPLITSOURCE
X = 35 - X = 33, but with sources fixed to be concentric.
X = 36 - gui34_A
...
guiFile = '/data/ljo31/Lens/J1125/gui_29b_D'
