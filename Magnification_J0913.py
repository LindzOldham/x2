...
for i in range(len(imgs)):
    ...
    img = imgs[i]
    galsub = img-galaxy
    pyfits.writeto('/data/ljo31/Lens/J0913/galsub_'+cols[i]+'.fits',galsub,clobber=True)
...
for i in range(len(imgs)):
    ...
    print reff, reff*0.05, reff*0.05*6.417
    # source redshift is 0.539 0 scale is 6.417 kpc / '' and 0.05 arcsec/pixel 
