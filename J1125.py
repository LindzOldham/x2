...
''' a new and mauch better PSF '''
psf1 = V[5044-14:5044+14,3771.5-14.5:3771.5+14.5]
psf1 = psf1/np.sum(psf1)
pl.figure()
pl.imshow((psf1),interpolation='nearest')
py.writeto('/data/ljo31/Lens/J1125/F606W_psf3.fits', psf1, clobber=True)
...
''' a new and mauch better PSF '''
psf1 = I[5043.5-14.5:5044.5+14.5,3771.5-14.5:3771.5+14.5]
psf1 = psf1/np.sum(psf1)
pl.figure()
pl.imshow((psf1),interpolation='nearest')
py.writeto('/data/ljo31/Lens/J1125/F814W_psf3.fits', psf1, clobber=True)
