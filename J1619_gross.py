...
Vcut = V[2320:2545,1855:2060] # big
...
V_wht_cut = V_wht[2320:2545,1855:2060] # big
...
# save both
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_sci_cutout_supergross.fits',Vcut,header,clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F606W_wht_cutout_supergross.fits',V_wht_cut,header_wht,clobber=True)
...
Icut = I[2320:2545,1855:2060] # big
...
I_wht_cut = I_wht[2320:2545,1855:2060] # big

pl.figure()
pl.imshow(np.log10(Icut),origin='lower',interpolation='nearest')

# save both
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_sci_cutout_supergross.fits',Icut,header,clobber=True)
py.writeto('/data/ljo31/Lens/'+str(name[:5])+'/F814W_wht_cutout_supergross.fits',I_wht_cut,header_wht,clobber=True)
