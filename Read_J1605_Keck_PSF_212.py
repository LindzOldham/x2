...
kresult = np.load('/data/ljo31/Lens/J1605/KeckPSF_final_212')
klp= kresult[0]
ka2=0
...
xoffset,yoffset,sig1,q1,pa1,amp1,sig2,q2,pa2,amp2,sig3,q3,pa3,amp3,sig4,q4,pa4,amp4 = ktrace[ka1,ka2,ka3]
